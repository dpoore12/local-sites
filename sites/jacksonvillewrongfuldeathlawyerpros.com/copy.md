# Copy — jacksonvillewrongfuldeathlawyerpros.com

**Wrongful Death Lawyer in Jacksonville, FL** · target keyword `jacksonville wrongful death lawyer`

## RULES

- Write for this city. Every block must be unreusable on another site.
- PHASE 1: home, about and contact only. No service pages.
- No firm, lawyer, result, fee, price, review, or credential is claimed here.

---

## meta_title

Jacksonville Wrongful Death Lawyer — Florida’s Personal Representative Rule

## meta_description

Florida wrongful death claims are brought by the estate’s personal representative, for statutory survivors and the estate. A plain guide to the two-year deadline and Duval County court.
...
What is Florida’s deadline for a wrongful death action?
...
Where would a Jacksonville wrongful death case be handled?
...
This is a Jacksonville-only information page about a Florida rule that deserves to be stated clearly: the personal representative of the estate, not each family member separately, brings a wrongful death action for survivors and the estate. It also explains Florida’s statutory definition of survivor, the ordinary two-year deadline, and the Fourth Judicial Circuit court context for Duval County. The page is not a law firm and does not pretend that an outcome, a claim value, or the right path can be known from a website. Its purpose is more limited: help a family recognize the procedural questions before misplaced authority, missing records, or an unattended date makes a hard situation harder.

## value_1_title

The representative rule, plainly stated
...
The survivor definition matters
...
Separate the questions before deciding
...
There is no need to arrive with a complete case file. The most helpful information is the death date, the basic event, who may have records, and whether an estate representative exists. Those facts make it possible to identify what needs attention first.

## expect_intro_2

The purpose of gathering information is not to pressure a family into filing. It is to avoid letting an insurance contact, a confusing document, or an assumption about who has authority make the decisions by default.
...
Record the day and the county or facility if known. A traffic crash, job-site event, hospital death, or other event may generate records in different places, and the date is essential to any deadline review.
...
Look for a will, probate case number, letters of administration, or paperwork naming a personal representative. Under Florida’s act, that role brings the wrongful death action for survivors and the estate.

## expect_3_label

A clear list of the family members

## expect_3

List a spouse, children, parents, and relatives who depended on the person for money or household help. The statutory survivor definition can be important even when the family arrangement is not simple.

## expect_4_label

Every letter, message, and report

## expect_4

Keep insurance letters, claim numbers, records requests, crash or incident documents, medical paperwork, and contact details. Do not assume a form is routine just because it arrived quickly.
...
Whether an estate is already open
...
The dates and records that can be preserved
...
Florida’s representative rule and two-year deadline, explained plainly

## values_eyebrow

What this Jacksonville page clarifies

## values_head

The procedural questions that come before a claim decision
...
Information worth having nearby

## expect_head

Four details that make the first legal review clearer
