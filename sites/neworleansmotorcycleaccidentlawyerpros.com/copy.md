...
### How you know this is the claim you have

An oncoming vehicle began turning while you were still traveling straight through the crossing. Contact usually lands on the car's front quarter panel or driver's door, and your front wheel, forks or engine case carries the matching mark. If the car was already deep into its arc, the damage sits farther back along its flank. Write down which lane you occupied, whether the turn came out of a dedicated pocket or from a through lane, and what the signal was displaying for you. Do that before anyone invites you to estimate a speed, because the estimate is what gets quoted back later.

### The rule the turning driver was under

Revised Statute 32:122 is one sentence long. A driver within an intersection intending to turn left shall yield the right of way to all vehicles approaching from the opposite direction which are within the intersection or so close as to constitute an immediate hazard. Nothing in that sentence asks whether the approaching vehicle was easy to see. The provision does not end the argument either. Distance, timing, visibility and physical proof still have to be established, and the turning driver will offer a version in which you were neither close nor visible.

### Why these crossings photograph badly

Canal Street and St. Charles Avenue carry streetcar track in the neutral ground, and rails, flangeways and paving joints change what a rider can do in the half second before impact. The city's own carnival guidance tells cyclists to cross tracks at a ninety-degree angle for that exact reason. Shoot the full approach from your position, then from the driver's position, then the resting places, then the surface in between. Wide frames fix the signal head and the sight line. Tight frames preserve the flangeway, the patch and the paint transfer, none of which survive a resurfacing contract.

### Prescription is the word, and the period recently changed

Civil law vocabulary applies here, so the deadline is a liberative prescription rather than a statute of limitations. Civil Code article 3493.1 gives delictual actions two years, commencing the day injury or damage is sustained. That period arrived through Acts 2024, No. 423, effective July 1, 2024, which also repealed article 3492 and the one-year rule the state was known for. The act is prospective only and reaches actions arising after that date, so a cause of action that arose earlier still lives under one year. Filing happens in a parish, not a county. Code of Civil Procedure article 74 permits a damages action where the wrongful conduct occurred or where the damage was sustained, and the general civil trial court for this parish is Civil District Court at 421 Loyola Avenue.

### What the first week should produce

Request the report through the police department's records channel; NOPD states that accident and criminal event reports should be available twenty working days from the date of the incident. Keep the item number. Find out which yard has the bike and whether storage is accruing against it. Photograph the helmet, jacket, gloves and boots before anything gets washed. Begin treatment and keep every discharge sheet, because a gap in care becomes an argument about causation. If a witness gave a name at the scene, call while the light phase is still a memory rather than a reconstruction.

### The mistake that hands over fifty-one percent

Article 2323 changed on January 1, 2026 through Acts 2025, No. 15. A claimant whose share of negligence falls below fifty-one percent recovers a proportionally reduced amount. At fifty-one percent or above, that claimant recovers nothing at all. Fault gets allocated among everyone who caused or contributed to the loss, whether or not they are parties. So a recorded statement in which a rider guesses at speed, or agrees that swerving was possible, is no longer merely unhelpful. It is an argument aimed at the cliff edge, and adjusters working this market know the edge is there.

### How the fee is set under Rule 1.5

The Rules of Professional Conduct permit a fee contingent on the outcome of a tort matter and forbid an unreasonable one, measured against eight listed factors. No percentage appears anywhere in the rule. Paragraph (c) requires the agreement in writing and signed, with a copy handed over at signing, stating separately the shares that apply on settlement, at trial and on appeal. Ask which litigation expenses come out of the recovery. Then ask whether those expenses are subtracted before or after the fee is calculated, because that ordering moves real money.
...
### The marks that separate a sideswipe from a solo fall

Paint down a rear door, a bent lever, a scored bar end, a torn jacket sleeve and a scuffed tank tell one story. A front wheel folded into a stationary bumper tells a different one. Photograph the whole flank of the other vehicle at a shallow angle so the streak reads, then the same flank of the motorcycle. Where there was no contact at all, because the car came over and you braked or steered off, no shared paint exists to find. That sequence has to come from video, from witnesses, and from marks left on the roadway.

### What Revised Statute 32:79 actually requires

Two clauses in the state's lane statute matter to a rider. A vehicle shall be driven as nearly as practicable entirely within a single lane. It shall not be moved from that lane until the driver has first ascertained that the movement can be made with safety. Read plainly, the burden sits on the driver who moved. "I checked my mirror" is an assertion about what was ascertained rather than proof of it, and the carrier will answer by talking about where the bike was positioned instead.

### The escape path this city often does not provide

Whether a rider had anywhere to go is a fact question, and here the honest answer is frequently that there was nowhere. The Office of Strategic Engagement reports the average pavement condition rating for city streets as Poor, a D-minus, with roughly 65 percent of streets rated poor or worse and about $5 billion needed to rebuild them. Subsidence drives much of that. Absolute subsidence across the city averaged 0.2 inches a year, plus or minus 0.1 inches, from 2002 to 2005, with parts of town moving more than 0.8 inches annually and NASA measurements showing spots above an inch a year.

### Rails, plates and the neutral ground

Track sits in the neutral ground along Canal Street and St. Charles Avenue and runs at street level on other downtown alignments. The transit agency's safety guidance notes plainly that streetcars, unlike buses, cannot stop suddenly. Steel plates over utility cuts appear and disappear on Quarter and downtown blocks with no notice to anybody who rides. Two habits help. Photograph the plate or the flangeway with something in frame for scale, and record the date, because the cut may be backfilled and repaved inside a week.

### When the street itself becomes part of the claim

Revised Statute 9:2800 bars liability against a public entity for the condition of a thing in its custody unless the entity had actual or constructive notice of the particular vice or defect, had a reasonable opportunity to remedy it, and failed to do so. Constructive notice means the existence of facts which infer actual knowledge. A 311 record therefore carries weight. Reporting a pothole by phone or at nola.gov/311 generates a service ticket number routed to the Public Works maintenance division, and a ticket predating a crash is documentary. City policy also routes personal injury or property damage claims arising from streets and sidewalks onto a specific form, CAO Form No. 19, received by the City Attorney's small claims division.

### The first week, in order

Get the item number and note which agency worked the scene. Photograph the bike from every side before it is released, repaired or crushed, and leave the gear unwashed. Report the pavement defect and save the ticket number. Pull the declarations page out of the glovebox and read the coverages instead of assuming them. Then write out, dated and in your own words, what you saw and did, because the version you give six months from now will be measured against this one.

### Percentages, prescription and fees

Article 2323 has barred recovery at fifty-one percent fault or more since January 1, 2026, and reduces damages proportionally below that line. Article 3493.1 allows two years from the day the injury is sustained for actions arising after July 1, 2024; before that date the older one-year prescription governs. Rule 1.5 states no percentage for a tort fee and instead tests reasonableness against eight factors. Paragraph (c) of that rule requires a signed writing setting out the settlement, trial and appeal shares and the treatment of expenses.
...
### Minimum limits are smaller than a single trauma admission
...
### The coverage claim carries its own deadline
...
### Suing the insurer directly is possible here, within limits
...
### Hit and run, and what actually preserves it
...
### What the agreement has to state about fees
...
### What negotiating a rider's claim consists of
...
### Fault gets divided, and the division has a hard edge
...
### Shares are assigned to people who were never sued
...
### Joint and divisible, and what that changes about collecting
...
### Intentional conduct and intoxication sit outside the reduction
...
### Where a rider's percentage actually comes from
...
### Local numbers, and why they get raised at all
...
### Employers and the people behind the driver
...
### Restrictions, work and the earnings record
...
### The medical expense side has its own timing rules
...
### Consortium claims inside a surgical file
...
### Fault, layers and the collection problem
...
### The calendar, and the records that expire sooner
...
### The exceptions that exist in the text
...
### The manufacturing side of the same statute
...
### Why the helmet is evidence for a rider, not just against one
...
### Where fault percentages actually come from
...
### The statewide picture riders are counted in
...
### What leaving the scene is, in statutory terms
...
### The right-of-way rule when nothing controls the crossing

Revised Statute 32:121 governs vehicles approaching or entering an intersection from different highways at approximately the same time. The driver on the left is required to yield to the vehicle on the right. The section modifies that rule where a driver is approaching on a highway not designated as a through highway, and it does not apply where traffic is otherwise controlled. On the residential grid off Freret, Broad or Elysian Fields, that single rule decides a large share of arguments, and the phrase doing the work is approximately the same time, which is a question of speed and distance rather than opinion.

### Stop signs, yield signs and the four-way crossing

Revised Statute 32:123 sets out what a stop actually requires. A driver approaching a stop sign stops at a clearly marked stop line, or before entering the crosswalk, or at the point nearest the intersecting roadway where the driver has a view of approaching traffic, and then yields to vehicles already in the intersection or approaching so closely as to constitute an immediate hazard. Where all approaches are controlled by stop signs, the first vehicle to stop goes first. A rolling stop is therefore two separate failures: the stop and the yield. Both leave physical traces in resting positions and damage patterns.

### Signals, and the hundred-foot requirement

Revised Statute 32:104 begins with a general rule that a driver may not turn or move right or left until the movement can be made with reasonable safety. Its signaling requirement is specific. A signal must be given continuously during not less than the last one hundred feet traveled before turning. The same section requires a signal before stopping or suddenly decreasing speed when there is an opportunity to give one to a following driver. For a rider approaching a crossing, that is the difference between a car that announced its intention and a car that simply appeared in the path.

### Why these crossings are hard to reconstruct here

Orleans Parish geometry works against clean sight lines. The neutral grounds along the major avenues carry streetcar track, and the transit agency's own safety guidance warns riders about rails and crossing them at an angle. Pavement condition is an aggravating factor rather than a footnote; the city's Office of Supervision and Engineering describes roughly sixty-five percent of streets as being in poor condition or worse. Add parked vehicles close to corners and mature street trees, and a driver's claim of an obstructed view becomes a factual question that only photographs from both approach positions can answer.

### What to photograph, and from where

Four sets of frames matter. From the rider's approach, at the rider's eye height, showing what was visible at fifty, a hundred and two hundred feet out. From the other driver's approach, showing the same. The resting positions before anything is moved, with a fixed reference such as a curb line or a manhole in frame. Then the surface between the two, capturing gouges, fluid, transfer paint and any defect. Wide frames establish geometry and traffic control. Tight frames preserve detail that a resurfacing contract or a patch crew erases within weeks.

### How the fault split gets argued

Because article 2323 makes fault a percentage and cuts recovery off entirely at fifty-one percent, the defense in an intersection file works the margins. Expect questions about speed, about whether braking started earlier, about lane position within the travel lane, and about whether the rider entered the crossing on a stale phase. Nothing in 32:121 or 32:123 asks whether the vehicle with the right of way was easy to see, but a percentage argument does. The answer is built from measurements and records, which is why an early recorded estimate of speed is worth more to an adjuster than it is to a rider.

### Getting the report and the item number

The crash report is the spine of the file. Revised Statute 32:398 requires a report where injury, death or property damage above five hundred dollars results, and requires the investigating agency to forward the report or its data to the Department of Transportation and Development within forty-eight hours of completing the investigation. The City of New Orleans publishes how police reports are requested, citing the Public Records Law and directing in-person requests to the Records and Identification Division at 1615 Poydras Street on weekdays between nine in the morning and three in the afternoon. Keep the item number; every later request runs through it.

### About this explainer

This page describes published right-of-way and signaling rules for general information and is not an assessment of fault in any particular collision, nor advice on how a claim should be handled. Which rule controls a crossing depends on the traffic control actually present and on evidence about timing and distance. Someone reviewing a specific crash should raise those details with the attorney who advertises on this site.
...
### Contracted providers cannot balance bill
...
### Public program reimbursement follows its own rules
...
### Get the itemized bill, not the balance
...
### Liens change the arithmetic of an offer
...
### Health coverage, not fault, usually pays first
...
### The current period, and the authority for it
...
### The following-distance rule, and an honest limit on quoting it
...
### The custody rule, and the knowledge it requires
...
### The injury the pavement here actually causes

A slide on New Orleans asphalt is not a slide on new pavement. The city's Office of Supervision and Engineering describes roughly sixty-five percent of streets as being in poor condition or worse, and the resulting surface, with exposed aggregate, patch edges, utility plates and streetcar rails in the neutral ground, tears rather than scuffs. Contamination follows: grit, oil, and organic debris driven into tissue. That is why the treating course frequently involves surgical debridement rather than dressing changes, and why infection is a documented risk rather than a remote one.

### What the law asks a claim to prove
...
### Photographing an injury that changes weekly
...
### Gear tells the story of the slide
...
### Fault still governs what is collectible
...
### Future care has to be tied to a manifest injury
...
### The public-entity cap, and the reversionary trust
...
### Liability against a public custodian is a notice case
...
### What a life care record needs to contain
...
### Fault allocation carries more weight here than anywhere
...
### Coverage almost never matches the loss
...
### Deadlines, and the claims that survive a death
...
### The retention duty, and why it matters to a rider
...
### Economic-only coverage is narrower than most people assume
...
### Stacking, layers and the order of payment
...
### Consent, releases and the mistake that ends the claim
...
### What the carrier's own clock requires
...
### Where water changes rider physics

Traction loss on a motorcycle is not gradual in the way it is in a car. Painted crosswalk bars and stop lines, metal utility plates, streetcar rails in the neutral ground and freshly sealed patches all lose grip disproportionately when wet. The transit agency's rider guidance about crossing tracks exists for that reason. Standing water hides depth, which is why a wet-weather file often has a defect component as well: article 2317.1 requires knowledge and preventability from the custodian of the thing, and Revised Statute 9:2800 requires actual or constructive notice by a public entity plus a reasonable opportunity to remedy.

### Following distance and visibility arguments

A wet rear-end collision brings in Revised Statute 32:81, which prohibits following more closely than is reasonable and prudent with due regard for speed, traffic and the condition of the highway. Braking distances lengthen; the distance actually kept does not adjust itself. The city ordinance on following too closely, at section 154-401 of the Code of Ordinances, covers the same ground within city limits. Drivers also raise wipers, fogged glass and glare from wet pavement at night. Those are conditions the statute already told them to account for, not excuses the statute recognizes.

### Building the record before the street dries

Weather evidence disappears in hours. Photograph standing water and its depth against a curb or a fixed object, the reflection pattern on the surface, and the tire tracks or lack of them. Note whether the drain at the corner was submerged or blocked, since drainage complaints belong in the 311 record. Capture the sky and the surrounding traffic conditions with timestamps intact. If tires are worn, expect that to be raised, so photograph the tread before the bike is repaired or scrapped, and keep the receipt if the tires were recent.

### How fault percentages get pushed in wet files

Article 2323 requires that a percentage be assigned to every person causing or contributing to the injury, party or not, and bars recovery entirely for a claimant at fifty-one percent or above. In a rain case, the defense argument is almost always the same shape: a reasonable rider would have slowed further, chosen another route, or not ridden at all. None of those propositions is in the statute. The reply is built from the other driver's specific failure, whether a turn made without reasonable safety under Revised Statute 32:104, a stop-sign yield under 32:123, or following distance under 32:81.

### The report, and the threshold that triggers it

Revised Statute 32:398 requires a crash report where injury or death results or where property damage exceeds five hundred dollars, and requires the investigating agency to forward the report or its data to the Department of Transportation and Development within forty-eight hours after completing the investigation. Copies are capped at five dollars for a report of two pages or fewer and twenty dollars for a longer one. Weather and surface notations in that report are frequently the only contemporaneous official description of conditions, which is why the report should be requested rather than waited for.

### Scope note

The provisions and the climate figure above are published sources presented for general understanding, not an opinion about responsibility in any wet-weather crash and not legal advice. Conditions on a given day, tire condition, and the other driver's conduct all matter, and none of them can be assessed from a general page. Those questions are for the attorney who advertises on this site, working from the actual record.
