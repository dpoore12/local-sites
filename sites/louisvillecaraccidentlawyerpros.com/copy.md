# Copy — louisvillecaraccidentlawyerpros.com

**Car Accident Lawyer in Louisville, KY** · target keyword `car accident lawyer louisville`

## meta_title

Louisville Car Accident Lawyer — No-Fault, PIP, Evidence & Claim Steps

## meta_description

Hurt in a Louisville crash? Learn what Kentucky no-fault coverage does, when it may limit a lawsuit, and what records matter after a Jefferson County collision.

## hero_promise

After a Louisville collision, the first job is to protect the claim before the evidence and paperwork get scattered. The case work starts with the crash report, vehicle photos, medical records, coverage information, and the Kentucky no-fault question that can change what may be claimed. A legal review should produce a concrete next-step list, not a guess about what an insurer will do.

## what_happens_when_you_call

The case is screened for the practical things that cannot wait: medical care, the location and date of the collision, the vehicles and insurers involved, whether a police report exists, and whether there is a deadline or a recorded-statement request on the table. Rear-end crashes, hit-and-runs, uninsured-driver claims, and a low offer need different records. The goal is to get the relevant documents preserved and the claim organized while the facts are still available. No case result can be promised, and no responsible person should predict one before the evidence and coverage are reviewed.

## what_they_will_ask

Have the crash date, the exact location, the report number if you have it, and the names of each insurer. Say whether an ambulance came, where you sought care, and whether you missed work or are still treating. If another vehicle left the scene, note anything you remember: plate digits, make, color, direction of travel, nearby cameras, or witnesses. For Kentucky drivers, pull out the declarations page too. Look for personal injury protection or basic reparation benefits, and look for any tort-limitation rejection you signed. That paperwork can matter as much as the police report.

## symptom_1_title

A rear-end crash left you hurt even though the damage looks small
...
The other driver left, and the report does not identify them

## symptom_2

A driver who leaves cannot be described accurately from memory a month later. Within the hour, write down direction of travel, color, body style, damage, lettering and any partial plate, then ask nearby businesses to hold exterior video before it cycles. Tell a police officer from the scene. Your own uninsured motorist coverage becomes the claim, and it lives on the declarations page.


## symptom_3_title

The at-fault driver has no insurance or too little coverage

## symptom_3

An empty liability policy does not end a Jefferson County claim; it moves the claim onto your own contract. Kentucky places uninsured motorist coverage in a liability policy unless a named insured rejected it in writing, while underinsured coverage exists only if somebody asked for it. Count the vehicles on the declarations page, and do not cash a small liability check before reading that endorsement.


## symptom_4_title

The insurer made an offer before your treatment or losses are clear

## symptom_4

An early number usually lands before the treatment file is finished. Ask which coverage it comes from, because reparation benefits, property damage, bodily injury and underinsured benefits are four separate subjects with four separate rules. Read what the release closes. One signature on a liability settlement can wipe out underinsured coverage that had thirty days to answer the notice.


## qa_1_question

Does Kentucky no-fault coverage stop me from suing after a Louisville crash?

## qa_1_answer

Not always. Kentucky drivers ordinarily accept the Motor Vehicle Reparations Act’s tort limitations unless they reject them in writing or electronically and file that rejection with the Department of Insurance before the crash. If you accepted the limits, basic reparation benefits can cover economic loss up to the statutory limit. An injury claim for pain and suffering may still be possible when medical expenses exceed the statutory threshold, or when the injury fits a listed serious category such as a fracture, a permanent injury, or death. If you rejected the limits before the collision, Kentucky law says you retain full tort rights, but that election can affect basic-reparation-benefit eligibility. The declarations page and any rejection form are worth locating before anyone makes a sweeping statement about whether you can sue.

## qa_2_question

Where would a Louisville auto-injury lawsuit be filed?

## qa_2_answer

Venue and jurisdiction depend on the facts, the parties, and the amount at issue, so no page can select a court for an individual claim. In Jefferson County, the Kentucky Court of Justice lists the Jefferson County Judicial Center at 700 W. Jefferson Street as housing Circuit Court and identifies Circuit Civil/Criminal among its functions. Kentucky Circuit Court is the court of general jurisdiction and hears civil matters above the District Court threshold. Filing is a formal step, not a bargaining tactic; it requires the correct parties, pleadings, service, and timing. Before any lawsuit is filed, the crash report, medical record, coverage documents, and applicable deadlines should be evaluated against the actual case.

## qa_3_question

What should I do in the first week after the crash?

## qa_3_answer

Seek medical attention when you need it, follow the care plan, and keep the records. Save the report number, photos, witness contacts, repair documents, insurer letters, receipts, and proof of missed work. Write down what happened while the details are fresh, including the weather, traffic flow, statements made at the scene, and any camera locations. Do not alter or dispose of the vehicle until necessary documentation is complete. Notify the appropriate insurer as the policy requires, but do not guess about fault, diagnoses, or future treatment. For a Kentucky crash, find the declarations page and determine whether the policy includes basic reparation benefits and whether any tort-limitation rejection was filed before the collision. Those documents shape the next steps.
...
This Louisville-focused page is built around the questions that most often change an auto-injury claim here: what the crash evidence shows, what the policies actually say, and whether Kentucky’s no-fault tort limits apply to the person who was hurt. Jefferson County’s road volume means a collision can involve a simple rear-end impact, an interstate-style multi-vehicle chain reaction, a hit-and-run, or an uninsured driver. The common thread is not a promised outcome. It is an organized record and a clear understanding of the coverage before a release, a missed notice, or a fading video creates a preventable problem.

## value_1_title

Kentucky no-fault explained in plain language

## value_1

The policy election is not fine print. The review checks whether the statutory tort limits applied on the crash date and what that means for PIP and a liability claim.

## value_2_title

Evidence organized before it disappears

## value_2

Reports, photos, witnesses, camera requests, medical records, vehicle documents, and insurer notices are sorted into one usable case file rather than left in scattered messages.

## value_3_title

Coverage questions separated from fault questions

## value_3

The facts of the crash, basic reparation benefits, uninsured-driver coverage, and a bodily-injury demand each have their own rules. Mixing them causes bad decisions.
...
The page is written for Louisville crashes and the Jefferson County court structure, not pasted from a generic national injury site.

## step_1_title

Preserve the collision record

## step_1

Gather the report number, photographs, witness details, vehicle information, medical records, and any time-sensitive camera leads. The aim is a complete factual record.

## step_2_title

Read the policies and the election

## step_2

Identify every potentially relevant policy, PIP or basic reparation benefits, and any written tort-limitation rejection that was effective before the collision.

## step_3_title

Choose the next legal step from the evidence

## step_3

A claim, demand, negotiation, or filing decision should follow the documents, coverage, and deadlines. It should not be forced by the first offer that arrives.

## expect_intro_1

A case review is most useful when it begins with records rather than recollection. Bring the crash information, coverage documents, medical timeline, and all insurer communication together. That makes it possible to see what is missing and what needs preserving.

## expect_intro_2

Kentucky’s no-fault rule is not a label to skip over. It affects the path of the claim. The crucial question is whether the driver accepted the usual tort limitations or filed a valid rejection before this particular collision.
...
Keep the report number, location, vehicle photographs, witness contacts, and any details pointing to video. If the report contains an error, note it without rewriting history; the underlying evidence matters too.
...
List every provider, test, medication, therapy appointment, work restriction, and day missed from work. The chronology is more useful than a loose pile of bills when a claim is evaluated.
...
Find policy limits, basic reparation benefits, uninsured- and underinsured-motorist coverage, and any notation about rejecting tort limitations. The coverage active on the crash date is what counts.

## expect_4_label

Every offer and release

## expect_4

Save the envelope, email, text, offer, and release document. Identify the carrier and coverage it concerns before responding. A signature can resolve more than the immediate repair bill.

## factor_1_title

Whether no-fault limits applied
...
The documented injury and treatment
...
Available coverage and notice dates
...
Evidence and coverage steps before the claim gets away from you

## values_eyebrow

Built for Louisville collision claims

## values_head

Start with records, coverage, and the Kentucky rule that applies

## values_lede

A collision claim moves better when the report, policy election, medical timeline, and insurer documents are assembled before an early offer sets the pace.

## factors_lede

Four questions shape a Louisville crash claim from the first week onward.

## problem_lede

These four situations create the documents and coverage questions that most often need attention after a Louisville wreck.

## problem_nudge

This page is general information, not a legal opinion about any individual claim. The evidence, coverage language, injuries, and deadlines need to be evaluated for the specific collision.

## expect_eyebrow

Build the record while it is still available

## expect_head

What to gather before making a final claim decision
...
to the amount charged for expenses. Eight factors set the measure. Labor and hours
weigh against the novelty and difficulty of the questions, alongside work turned away to
take the case and the going local charge for similar service. The rest are the stakes
against the outcome, the deadlines in play, the history between lawyer and client,
reputation, skill and standing, and whether payment is fixed or rides on the result. No percentage appears. For a crash on
...
than judgment. The tiers run twenty percent of the first $25,000 of the award, fifteen
percent of the next $25,000, and ten percent of the remainder. The maximum fee is $18,000
for contracts signed on or after July 14, 2018. No fee is paid until an administrative law judge approves it, the
...
client. It has to state how the amount is determined and the percentages accruing on
settlement, at trial and on appeal. It also has to state which litigation outlays get
charged against the sum collected, and whether that subtraction happens ahead of the fee
calculation or after. Two
...
Paragraph (d) closes two doors. No fee may ride on the result for a criminal defendant. And
none may ride on securing a divorce or on the amount of alimony, maintenance, support or
property settlement, apart from liquidated sums already in arrears.
...
them. KRS 304.39-060 then allows recovery for pain, suffering, mental anguish and
inconvenience only where medical expense benefits exceed $1,000. The alternative route is a
listed injury: permanent disfigurement, a bone fracture, loss of a body member, permanent
injury within reasonable medical probability, permanent loss of bodily function, or death.
...
## svc_comparative_fault_in_kentucky_body

<h2>The statute assigns percentages rather than picking a winner</h2>
<p>KRS 411.182(1) directs that in all tort actions involving fault of more than one party, including products liability, the court or jury make findings on two separate points. The first is the amount of damages each claimant would be entitled to recover if contributory fault were disregarded. The second is the percentage of the total fault of all the parties to each claimant, each defendant, each third-party defendant and each person who has been released from liability. Nothing in the section makes any percentage a cutoff. A claimant found substantially at fault still recovers, with the award reduced by that percentage, which is the practical difference between Kentucky's approach and the older rule that eliminated a claim entirely.</p>
<h2>What the fact finder is told to weigh</h2>
<p>Subsection (2) supplies the analytical framework: in determining the percentages, the trier of fact considers both the nature of the conduct of each party at fault and the extent of the causal relation between that conduct and the damages claimed. Those are two distinct inquiries, and they can point in opposite directions. Conduct can be egregious yet only loosely connected to the harm; conduct can be minor yet directly productive of it. In a Louisville crash file that framework is why arguments about speed, attention, signal use, following distance and even seat position get developed separately rather than lumped into a general claim of carelessness.</p>
<h2>How the judgment is written</h2>
<p>Subsection (3) requires the court to determine the award of damages to each claimant in accordance with the findings, reduce the award by the claimant's percentage of fault, and enter judgment against each liable defendant, with the judgment stating as separate findings each defendant's equitable share of the obligation in accordance with the percentages. The word share matters: a defendant found ten percent responsible has that figure recited in the judgment. Subsection (5) also permits a defendant liable for another's percentage under an indemnity or vicarious liability theory to be held responsible on that basis, so the arithmetic is not always limited to a party's own personal conduct.</p>
<h2>Settling with one party changes the math for the rest</h2>
<p>Subsection (4) is the provision that surprises people. A release, covenant not to sue or similar agreement given in good faith to one of two or more persons liable in tort for the same injury discharges that person from all liability for contribution, and it reduces the claim against the others to the extent of any amount stipulated by the release, or to the extent of the released person's equitable share of the obligation, whichever is larger. The reduction is measured by the released party's assigned share, not simply by the dollars paid. Settling early and cheaply with one defendant in a multi-vehicle case can therefore reduce what remains recoverable from the others by more than the settlement was worth, which is why the sequence of settlements in a chain collision is a strategic question rather than a clerical one.</p>
<h2>Fault allocation runs alongside the reparation statutes</h2>
<p>Kentucky's no-fault architecture sits over the top of all this. Tort liability for bodily injury from motor vehicle use is abolished to the extent basic reparation benefits are payable, and noneconomic damages are available only where the medical expense benefits payable exceed $1,000 or the injury falls in one of the categories the statute lists. Comparative fault then applies to what remains. In sequence: reparation benefits pay economic loss without regard to fault up to their ceiling, the threshold question determines whether noneconomic damages are available at all, and the percentages under KRS 411.182 reduce the liability recovery. A file that skips a step produces a valuation that cannot be defended.</p>
<h2>The conduct rules that supply the raw material</h2>
...
<h2>What comparative fault means for how a file is built</h2>
<p>Because the outcome is a percentage rather than a verdict on a single question, the record needs to make each party's contribution visible and quantified. That favors specific documentation over general narrative: measured distances rather than impressions, dated photographs rather than descriptions, signal and sign positions rather than assumptions about who had the light, and treatment records that connect each complaint to the collision so causal relation can be shown as well as asserted. It also favors caution in recorded statements, where an offhand concession becomes a percentage later. This page is a general explanation of Kentucky's comparative fault statute and not legal advice about any particular case; the attorney advertising on this site is the person to review how these percentages might apply to a specific crash.</p>

## svc_crash_reports_and_evidence_lede

Kentucky crash reports are not public records in the ordinary sense. The statute makes them confidential, lists who may obtain one, and forbids release for commercial purposes, which changes how a claim file gets built.

## svc_crash_reports_and_evidence_body

<h2>Who is required to report, and when</h2>
<p>KRS 189.635(3)(a) requires the operator of a vehicle involved in an accident resulting in injury, death or property damage to immediately notify the nearest police agency or a peace officer, and paragraph (b) puts that duty on the owner where the driver did not do it. Subsection (4)(a) requires the officer who investigates to file a written report of the accident with the Department of Kentucky State Police within ten days after completing the investigation. Subsection (5)(a) covers the situation where no officer investigated: the driver must file a written report within ten days where the damage to any one person's property exceeds $500. Louisville Metro Police directs drivers to file that report through the Kentucky State Police Online Civilian Traffic Collision Report and states that the state police no longer accept the paper civilian version.</p>
<h2>Confidentiality is the default</h2>
<p>KRS 189.635(6)(b) makes accident reports filed under the section confidential and exempt from the open records provisions in KRS 61.870 to 61.884, other than as the section provides or under a subpoena or court order. Paragraph (c) then lists who may obtain a copy: the parties to the accident, the parents or guardians of a minor party, the insurers of any party or their written designee, the attorneys of the parties, a person or entity that has filed a civil action arising from the accident and provides a copy of the first page of the complaint stamped by the circuit or district clerk, the Department of Workplace Standards, and law enforcement. Subsection (7)(a) prohibits release for a commercial purpose. Anyone in the listed categories can get the report; anyone outside them generally cannot, which is why solicitations arriving days after a crash are worth a second look.</p>
<h2>Fees and how a Louisville report is actually obtained</h2>
<p>Subsection (8) directs the Department of Kentucky State Police to establish a fee schedule by administrative regulation for reports it releases. Locally, Louisville Metro Police publishes three routes to a report and prices an accident report at $10 each, with incident reports at $2 each. Online requests are answered within twenty-four to seventy-two hours, and reports can also be picked up in person at 701 West Ormsby Avenue, Suite 001 in the basement, Louisville, Kentucky 40203, with a records number listed as 502-574-6857. Locating a report requires the report number, the report date and the last name of a driver or vehicle owner. Where the Kentucky State Police filed the report rather than the metro department, the request goes to the state police instead.</p>
<h2>One narrow exception for news organizations</h2>
<p>Subsection (9) allows release to a news-gathering organization solely for the purpose of publishing or broadcasting the news, with conditions attached, and defines the term using objective tests, including publication or broadcast at least fifty of the previous fifty-two weeks and a content standard framed around at least twenty-five percent news content or no more than seventy-five percent advertising. The provision matters less for a claim than for understanding the structure of the statute: the legislature carved out identified recipients rather than opening the file.</p>
<h2>What the report does and does not establish</h2>
<p>A collision report records the investigating officer's observations, the diagram, the identified vehicles and drivers, insurance information as reported at the scene, any citations issued and a narrative. It is a starting point rather than a determination of liability, and error in the insurance information or the sequence description is common enough that neither should be relied on without verification. Where a citation was issued, the outcome of the citation is a separate record with its own path, and where the diagram conflicts with the physical evidence, the physical evidence is the more durable of the two.</p>
<h2>The evidence that disappears while the report is being obtained</h2>
<p>Reports keep. Most other evidence does not. Camera footage held by a business, an apartment complex or a transit vehicle is typically retained for a period measured in days. Vehicles are repaired, sold or scrapped, taking crush measurements and event data recorder contents with them. Roadway conditions change, especially inside an active construction project. Witness recollection degrades and phone numbers change. That timing mismatch is the reason preservation requests are sent in the first week, in writing, dated, and specific about what is being asked for and from whom, rather than after the report arrives.</p>
<h2>A workable order of operations</h2>
<p>For an ordinary Louisville crash the sequence is straightforward: confirm the report number and the investigating agency at the scene or shortly after, file the civilian report if no officer investigated and the damage exceeds the statutory figure, request the report through the correct agency, photograph both vehicles and the location before repairs, identify camera owners along the route and ask in writing that footage be preserved, and keep a dated log of every request made. This page explains Kentucky's crash report statute and local records practice in general terms rather than providing legal advice, and questions about a specific report or preservation issue belong with the attorney advertising on this site.</p>
...
## svc_intersection_and_failure_to_yield_crashes_body

<h2>The default rule, before any sign is involved</h2>
<p>KRS 189.330(1) sets the baseline: where two vehicles approach or enter an intersection from different roadways at approximately the same time, the driver on the left yields to the driver on the right. Subsection (2) immediately notes that the baseline is modified at through intersections and elsewhere in the chapter, which is why the rule is rarely the whole answer in Louisville. Subsection (3) authorizes the state highway commissioner for state highways and local authorities for roads under their jurisdiction to designate stop or yield intersections and erect the signs. The first question in an intersection file is therefore which control was in place, because that determines which of the statute's later subsections governs the movement.</p>
<h2>Stop signs and yield signs create different duties</h2>
<p>Under subsection (4) a driver approaching a stop sign stops at a marked stop line, or before the near crosswalk if there is no line, or at the point nearest the intersecting roadway where approaching traffic can be seen. Having stopped, that driver yields to any vehicle in the intersection or approaching closely enough to be an immediate hazard, and that duty continues while the driver is moving across the intersection. A yield sign, addressed in subsection (5), requires slowing to a speed reasonable for conditions and stopping if safety requires it, then the same yield to immediate hazards. The subsection ends with a provision that shapes proof: where a driver passes a yield sign without stopping and then collides with a vehicle in the intersection, the collision is deemed prima facie evidence of a failure to yield the right-of-way.</p>
<h2>Turning movements have their own subsections</h2>
<p>Left turns generate a large share of these collisions and Kentucky covers them twice. Subsection (6)(b) requires the turn to be approached in the extreme left-hand lane lawfully available and, where practicable, made to the left of the center of the intersection, leaving in the extreme right-hand lane available on the road being entered. Subsection (9) is the yielding rule: a driver turning left within an intersection or into an alley, private road or driveway yields to oncoming traffic that is in the intersection or so close to it as to constitute an immediate hazard. Subsection (10) covers entering or crossing a roadway from a place that is not a roadway, such as a parking lot or a driveway, and requires yielding to everything already on the road. Subsection (11) governs shared center turn lanes: a left turn may not be made from any other lane, and the center lane may not be used except in preparing for or making that turn or merging after one.</p>
<h2>Signals, devices and the movement nobody signals</h2>
<p>Subsection (7) allows the Transportation Cabinet and local authorities to place traffic control devices directing a different course than the statute describes, and once those devices are in place a driver may not turn other than as directed. Subsection (8) forbids turning to proceed in the opposite direction unless the movement can be made safely and without interfering with other traffic, which is the provision that reaches a mid-block turn across traffic. Pedestrians are in this picture too: KRS 189.570(4) requires a driver to yield, slowing or stopping if needed, to a pedestrian crossing the roadway where signals are not in place or operating, and subsection (5) forbids overtaking a vehicle that has stopped at a crosswalk to let someone cross.</p>
<h2>Proving who entered first</h2>
<p>Nobody measures approximately the same time with a stopwatch, so intersection files are built from converging evidence. Signal timing and phase data, where the agency retains it, can establish which movement had a green indication. Vehicle damage patterns show impact angle and therefore relative position. Final rest positions and debris distribution indicate speed and direction. Nearby businesses and residences sometimes hold video for a matter of days, so a dated written request early is worth more than a subpoena later. Independent witnesses in a queue behind either driver often saw more than either driver did.</p>
<h2>Both drivers usually carry some argument</h2>
<p>Kentucky assigns percentages rather than winners. Under KRS 411.182 the trier of fact allocates the total fault among every party to the claim, including released parties, and the court states each party's equitable share, with a release reducing the claim by the released party's equitable share rather than by whatever that party paid. In an intersection case that structure invites arguments running both directions at once: a driver with the right-of-way may still be said to have been inattentive or fast, and a driver who rolled a stop may still point to an unlit or speeding vehicle. Because Kentucky abolishes tort liability to the extent reparation benefits are payable, the reparation ledger has to be read alongside the fault analysis rather than after it.</p>
<h2>The first two weeks of an intersection file</h2>
<p>Useful early steps are unglamorous: get the report number and the investigating agency, photograph sight lines and any vegetation or parked vehicles blocking a view, note the position of every sign and signal head, identify the businesses with cameras facing the approach, and write down the names of everyone who stopped. Nothing on this page is legal advice about a particular collision — it is a description of Kentucky's right-of-way statutes — and a specific intersection crash is a conversation for the attorney advertising on this site.</p>

## svc_interstate_and_highway_collisions_lede

Interstate collisions in and around Louisville involve rules that only apply at highway speed: lane restrictions for trucks, a limit on travel in the leftmost lane, and a statutory duty to move a damaged vehicle off the roadway when nobody was hurt.

## svc_interstate_and_highway_collisions_body

<h2>Lane discipline is a statute, not a courtesy</h2>
<p>KRS 189.340(7)(a) requires a vehicle on a roadway divided into two or more clearly marked lanes to be driven as nearly as practicable entirely within a single lane, and not moved from that lane until the driver has ascertained the movement can be made with safety. Paragraph (c) restricts the leftmost lane on roadways divided into three or more lanes for traffic in one direction: a truck tractor-semitrailer or a vehicle with three or more axles may not travel there except when preparing to turn left, when entering or leaving by a left-hand ramp, when directed by a traffic control device, or when the other lanes are obstructed. Subsection (8) adds the rule most drivers know as the slower-traffic provision, forbidding travel in the leftmost lane of a limited access highway with four or more lanes and a posted limit of at least sixty-five miles per hour except to overtake, to yield to merging or emergency traffic, when conditions warrant, or as directed. Subsection (5) requires an overtaking driver to return to the right side before coming within two hundred feet of an approaching vehicle.</p>
<h2>Following distance at seventy miles an hour</h2>
<p>The following-distance rule reaches interstates through the same statute. KRS 189.340(9)(a) bars following more closely than is reasonable and prudent given speed, traffic and highway condition, which at highway speed is a much longer distance than the same words describe on a city street. Paragraph (b) fixes a floor of two hundred fifty feet for a motor truck, semitrailer truck, bus or heavy construction equipment unit outside a business or residential district, subject to a lane-designation and overtaking exception, and paragraph (c) exempts the trailing vehicles in a commercial platoon while keeping the duty on the lead vehicle. A stopped or slowing queue on a limited access highway is where those distances get tested.</p>
<h2>The duty to clear the roadway, and its exceptions</h2>
<p>KRS 189.580(1)(b) applies specifically to collisions on interstate highways and state parkways. Where the collision did not result in death, in an injury that is known or visible, or in the release or potential release of hazardous materials, each driver is required to move the vehicle off the roadway, and the exchange obligation expands to include insurance information along with the registration number and identifying details. Where death, visible injury or hazardous material is in the picture, the vehicles stay put. Subsection (4) allows a peace officer or authorized public employee to remove a vehicle or debris obstructing traffic and shields that person from liability for damage caused by reasonable removal efforts, and subsection (5) defers removal in fatality and visible-injury cases until medical and firefighting personnel have finished and the scene has been investigated. Those provisions explain why some interstate scenes are cleared in minutes and others sit for hours, and why photographs taken before a vehicle is moved are often the only record of original position.</p>
<h2>The Sherman Minton corridor as an example of the environment</h2>
<p>Highway conditions here are not static. The Sherman Minton Renewal rebuilt the double-decked Ohio River crossing that carries I-64 and US 150 between Louisville and New Albany, a structure the project describes as sixty-one years old and used by about seventy thousand drivers a day, with project limits running from Exit 123 in Indiana to I-264 in Kentucky. It was delivered as a design-build project led by the Indiana Department of Transportation in partnership with the Kentucky Transportation Cabinet, with the Indiana Finance Authority awarding the contract to Kokosing Construction Company. Work included replacing or refurbishing the decks, rehabilitating structural steel and hanger cables, drainage repairs, new lighting and painting, and the project set substantial completion in mid-November 2024, after which all six lanes on both decks returned to traffic. Long-running projects like it produce shifting lane geometry, temporary striping and changing merge points, all of which belong in the description of a crash that happened inside one.</p>
<h2>Work zones carry an extra layer</h2>
<p>KRS 189.290(4) forbids operating a vehicle in a reckless or negligent manner that endangers persons or property in or near a highway work zone, and subsection (5) attaches license revocation exposure under KRS 186.560 to that violation. In a work zone file the physical layout is itself evidence: where the taper began, which lane was closed, what signage preceded the closure, and whether the posted limit had been reduced. Photographs and video from the day of the crash age quickly because the configuration changes as the work advances, sometimes within the same week.</p>
<h2>Why highway crashes exhaust reparation benefits first</h2>
<p>Highway speed changes the medical picture and therefore the money. Kentucky's basic reparation benefit is capped at $10,000 for all economic loss suffered by one person in one accident, and no one recovers those benefits from more than one obligor for the same crash. A single air ambulance transport and one night in a trauma unit can consume that ceiling. What follows is a liability claim against whoever is responsible, measured under the fault allocation in KRS 411.182 and limited by whatever coverage exists; Kentucky's minimum liability security is $25,000 per person and $50,000 per accident for bodily injury with $25,000 in property damage, or a $60,000 single limit, which is why coverage on every involved vehicle gets identified early.</p>
<h2>Multi-vehicle scenes need names collected at the scene</h2>
<p>Chain collisions on I-64, I-65, I-71 or the Watterson produce several drivers, several insurers and several versions of the sequence. The practical steps are to record every plate present, ask each driver which vehicle they felt strike them and from where, note the responding agency and report number, and photograph final rest positions before the clearance duty moves anything. This page explains Kentucky highway statutes generally rather than giving legal advice, and the attorney who advertises on this site is the appropriate person to review an actual interstate collision.</p>

## svc_kentucky_no_fault_and_pip_benefits_lede
...
<h2>The exception that can lift the tort limitations</h2>
<p>KRS 304.39-060(2)(c) provides that the abolition of tort liability in paragraph (a) does not apply to injury to a person who is not an owner, operator, maintainer or user of a motor vehicle within the meaning of the subtitle, and also does not apply to a person injured while a passenger on a motorcycle. Where the exception applies, the medical expense threshold and the abolition provision do not restrict the claim. Its reach is limited by the definitions: KRS 304.39-020(15) defines a user as a person who resides in a household in which any person owns or maintains a motor vehicle, so a pedestrian who lives in a household with a registered car is generally still a user. The exception has to be evaluated against the household facts rather than against the fact that the injured person was walking.</p>
<h2>Bicycles and scooters are not motor vehicles for this purpose</h2>
<p>KRS 304.39-020(7) defines motor vehicle for the subtitle and expressly excludes mopeds and electric low-speed scooters from the definition. A conventional bicycle is likewise not a vehicle of the kind the definition describes. That has a practical effect on which policy pays: the reparation benefit follows the motor vehicle involved rather than the bicycle, so the analysis proceeds through the priority rules instead of through the cyclist's own vehicle coverage.</p>
<h2>Which insurer pays the first bills</h2>
<p>KRS 304.39-050(1) states the priority. For a person injured while occupying a motor vehicle the applicable security is the coverage on that vehicle; for a person injured while not making use of a motor vehicle, the applicable security is the coverage on the vehicle that struck them. The subsection defines a pedestrian for its own purposes as any person not making use of a motor vehicle at the time of injury, which is the definition that brings cyclists within the rule. If the obligor does not pay within thirty days of receiving reasonable proof of the fact and amount of loss, the injured person may claim under a policy under which they are an insured, and the paying insurer is entitled to reimbursement. Subsection (2) covers the case where the striking vehicle carried no security, and subsection (3) caps the whole recovery at one obligor and $10,000 for one person in one accident. The Department of Insurance also notes that a policy on which everyone in the household has rejected the tort limitations must include guest coverage that provides these benefits to guest passengers and pedestrians.</p>
<h2>Driver duties toward people on foot</h2>
<p>KRS 189.570 sets out the rules in both directions. Subsection (4) requires a driver to yield, slowing or stopping if needed, to a pedestrian crossing the roadway where traffic signals are not in place or not in operation. Subsection (5) bars overtaking another vehicle that has already stopped at a crosswalk so someone could walk across. Subsection (6)(d) puts a due care duty on every driver to avoid striking anyone on foot, calls for a horn warning where one is needed, and requires added caution around a child or a person who is plainly confused or incapacitated. Subsection (8) requires a driver emerging from or entering an alley, building, private road or driveway to yield to a pedestrian on a sidewalk.</p>
<h2>Pedestrian duties, which become fault arguments</h2>
<p>The same statute imposes obligations on the person walking. Subsection (6)(a) requires a pedestrian crossing a roadway at a point other than a marked crosswalk or an unmarked crosswalk at an intersection to yield to vehicles on the roadway. Paragraph (c) prohibits crossing between adjacent intersections where traffic control signals are in operation, other than in a marked crosswalk, within the limits of a city. Subsection (9) forbids a pedestrian from suddenly leaving a curb or other place of safety and moving into the path of a vehicle so close that the driver cannot yield. Because Kentucky allocates fault as percentages under KRS 411.182 and no percentage bars recovery, these provisions typically reduce a claim rather than defeat it.</p>
<h2>The three-foot rule and other cycling provisions</h2>
<p>KRS 189.340(2)(a)2 addresses overtaking a bicycle or an electric low-speed scooter, requiring the operator of the passing vehicle to maintain a distance of at least three feet between the vehicle and the bicycle or scooter. The subsection also addresses when a driver may cross the center line to accomplish that pass. Measurement in a real collision is rarely available, so the provision functions in practice through the physical evidence: point of impact on the vehicle, the position of the bicycle after the collision, and any lane width and marking data for the roadway.</p>
<h2>What the statewide numbers show</h2>
...
Being struck from behind rarely settles the question of blame in Kentucky, because the following-distance rule is written as a standard rather than a measurement. What decides these files is what the traffic ahead was doing and what the vehicle behind could see.

## svc_rear_end_collisions_body

<h2>The rule is a judgment call, written that way on purpose</h2>
<p>KRS 189.340(9)(a) says a driver shall not follow another vehicle more closely than is reasonable and prudent, with regard for the speed of the vehicle and the traffic upon and condition of the highway. There is no car length figure in the statute for ordinary vehicles, so the phrase does the work: what was prudent in dry mid-afternoon traffic on Bardstown Road is not prudent behind a truck on wet pavement approaching a stopped queue. Paragraph (b) does supply a number for heavier vehicles, requiring a motor truck, semitrailer truck, bus or heavy construction equipment unit traveling outside a business or residential district to stay at least two hundred fifty feet behind another vehicle, with an exception for lanes designated for such vehicles and for overtaking. Paragraph (c) removes both rules from a trailing vehicle in a commercial platoon while keeping them on the vehicle leading it.</p>
<h2>The general duty statute sits underneath</h2>
<p>Kentucky also imposes a plain operating standard. KRS 189.290(1) requires a driver on a highway to operate carefully, with regard for the safety and convenience of pedestrians and other vehicles, and subsection (4) forbids operating a vehicle in a reckless or negligent manner that endangers persons or property in or near a highway or a highway work zone. Subsection (5) adds license revocation exposure under KRS 186.560 for a violation of subsection (3) or (4). In practice a rear-end file often cites the following-distance rule and this careless-operation duty together, because the second reaches conduct the first does not describe, including attention drifting away from the road.</p>
<h2>What the driver in front was doing still matters</h2>
<p>An impact from behind does not end the fault inquiry, and Kentucky's allocation statute makes that concrete. KRS 411.182(1) has the fact finder set the damages a claimant would recover if contributory fault were disregarded, then assign percentages of the total fault of all parties to the claim, including third-party defendants and anyone released. Subsection (2) directs attention to two things at once: the nature of each party's conduct and how closely that conduct is causally related to the damages claimed. So an unlit vehicle, an abrupt lane change into a closing gap, a reversing movement in traffic, or a stop made for no discernible reason all get weighed rather than ignored. Subsection (3) then has the court state each party's equitable share in the judgment.</p>
<h2>Jefferson County's crash volume changed shape recently</h2>
<p>Rear-end collisions need speed followed by a stop, and this county produces both in quantity. The Kentucky Transportation Center's five-year analysis reports Jefferson County counts on roads with known traffic volume of 14,830 crashes in 2020, 14,385 in 2021, 16,522 in 2022, 24,677 in 2023 and 25,417 in 2024, against a previous four-year average of 17,604 — a 44.4 percent increase. The same table records 1.2 percent of those Jefferson County crashes as fatal and 4.2 percent as injury or fatal. Statewide the report counts 117,661 crashes in 2024 and 707 traffic deaths. Volume of that order is why the specific evidence in one file gets stale fast: nearby cameras overwrite, vehicles are repaired or scrapped, and witnesses stop remembering which lane was blocked.</p>
<h2>The evidence that decides the closing speed</h2>
<p>The physical record answers questions memory cannot. Crush depth and the location of damage across the bumper indicate whether the impact was square or offset. Airbag control module data, where a vehicle records and retains it, can hold pre-impact speed and brake application. Debris fields and skid or scuff marks fix the point of impact relative to the stop line. Photographs of both vehicles before repairs, of the roadway, and of any queue backed through an intersection are worth more than a paragraph of recollection. Where a truck was involved, the vehicle's own electronic systems and the carrier's records join the list, and preservation is worth asking for in writing and dating.</p>
<h2>Recorded statements ask for numbers no one has</h2>
<p>Insurance adjusters ask how many car lengths back the vehicle was, how fast it was closing, and how long the vehicle ahead had been stopped. Those are estimates, and once given they are quoted later as measurements. Declining to guess is not evasive. Two related habits do real damage in the first week: authorizing salvage before the vehicle's condition is documented, and describing injuries as minor at a roadside, hours before stiffness and headache set in.</p>
<h2>Where the paperwork goes next</h2>
<p>The claim file that holds up is boring and complete: the report number and the investigating agency, both declarations pages, dated photographs, a treatment timeline with the bills attached, and a written record of who was asked to preserve what. Louisville Metro Police makes accident reports available through its records process for a $10 fee per report, and asks for the report number, report date and a driver or owner surname to locate one. This page describes Kentucky rules in general terms and is not legal advice; questions about a specific rear-end collision belong with the attorney who advertises here.</p>

## svc_rejecting_no_fault_in_writing_lede
...
## svc_statute_of_limitations_kentucky_body

<h2>The general personal injury period is one year</h2>
<p>KRS 413.140(1)(a) requires an action for an injury to the person of the plaintiff to be commenced within one year after the cause of action accrued. That is among the shortest such periods in the country, and it is the figure that applies to injury claims generally rather than to motor vehicle claims specifically. Knowing the general rule matters even in a crash case, because claims that are not motor vehicle tort claims within the meaning of the reparation statutes may be measured by it, and because it explains why Kentucky practitioners treat the calendar as an early rather than a late concern.</p>
<h2>The motor vehicle period is written into the reparation act</h2>
<p>KRS 304.39-230(6) supplies the deadline for a tort action arising from a motor vehicle accident that the no-fault statute has not abolished. Such an action may be commenced not later than two years after the injury, the death, or the date of issuance of the last basic or added reparation payment, whichever occurs later. The choice of the later date is the important part: where reparation benefits are still being issued, the two-year period runs from the last of them rather than from the crash. Two consequences follow. A claim can remain timely well beyond two years after the collision, and a claim can also expire while a client believes the crash date controls, because benefits stopped earlier than expected.</p>
<h2>The replacement payment trap</h2>
<p>The same subsection anticipates an obvious problem with a deadline tied to a payment date. Where a payment is reissued in the same amount because the original was lost, stolen or never delivered, that reissued payment is a replacement payment and does not extend the date from which the period runs. The subsection also gives a mechanism for finding out: on written request, the reparation obligor must state whether a particular payment was a replacement payment. Anyone relying on a payment date to establish timeliness has a reason to send that written request rather than assume, since the difference between a benefit payment and a replacement of one can be the difference between a filed claim and a barred one.</p>
<h2>Claims for the benefits themselves have separate deadlines</h2>
<p>KRS 304.39-230(1) governs an action for basic or added reparation benefits: it must be commenced not later than two years after the reparation claimant suffers the loss and either knows, or in the exercise of reasonable diligence should know, that the loss was caused by the accident, or not later than four years after the accident, whichever is earlier. Where benefits have been paid for loss arising otherwise than from death, an action for further benefits may be commenced not later than two years after the last payment. Subsection (2) addresses survivor's benefits, allowing an action not later than one year after the death or four years after the accident, whichever is earlier, with a similar provision measured from the last payment where benefits have been paid. These are different periods from the tort period, and they can expire while a liability claim is still pending.</p>
<h2>Legal disability is treated differently here than elsewhere</h2>
<p>Kentucky's general tolling statute, KRS 413.170, provides that where a person entitled to bring an action was at the time the cause of action accrued an infant or of unsound mind, the action may be brought within the same number of years after the removal of the disability, and it identifies the periods it applies to as those in KRS 413.090 to 413.160. The reparation act contains its own provision, and KRS 304.39-230(5) states that in the case of legal disability the period of that disability is deemed part of the time limited by the section. Because those two provisions do not read the same way, the assumption that a minor's motor vehicle deadline is automatically extended is not one to make without checking the specific claim against both texts.</p>
<h2>Notice provisions inside insurance policies are not statutes</h2>
<p>Separate from anything in the statutes, coverage claims carry contractual deadlines. Uninsured and underinsured motorist claims are the common example: KRS 304.39-320(3) builds a series of thirty-day windows around written notice of a tentative settlement, consent, waiver or payment to preserve subrogation, and the policy itself will add prompt notice and cooperation requirements. Complying with a statutory limitation period while missing a policy notice provision produces the same practical result as missing the statute. Both belong on the same calendar.</p>
<h2>Practical calendaring after a Kentucky crash</h2>
<p>The workable habit is to write down four dates at the beginning of a file: the crash date, one year out, two years out, and four years out, then add the date of every reparation payment as it is received and confirm in writing whether any of them was a replacement payment. Where a claim involves a minor, a person under a disability, a governmental entity or an out-of-state defendant, the analysis gets more complicated rather than simpler. This page describes Kentucky limitation statutes in general terms and is not legal advice; deadlines in an actual claim should be confirmed with the attorney who advertises on this site well before any of them approaches.</p>

## svc_traumatic_brain_injury_claims_lede

A brain injury changes the claim's structure, not just its value. The threshold question is usually resolved by the diagnosis, the benefit ceiling is exhausted immediately, and the funding sources that remain each come with their own limits.

## svc_traumatic_brain_injury_claims_body

<h2>The threshold categories a brain injury tends to satisfy</h2>
<p>KRS 304.39-060(2)(b) permits recovery of noneconomic damages where medical expense benefits exceed $1,000 or the injury falls into a listed category, and two of those categories are written for exactly this situation: permanent injury within reasonable medical probability, and permanent loss of a bodily function. A skull fracture also qualifies under the fracture language. What matters procedurally is that the permanency categories require medical opinion rather than arithmetic, which means the neurological and neuropsychological record carries the threshold rather than the billing ledger. Mild traumatic brain injury with persistent symptoms is the harder case, because objective imaging is frequently normal and the documentation has to come from function.</p>
<h2>The exception for people who were not using a vehicle</h2>
<p>One provision is easy to miss and matters in pedestrian, cyclist and bystander brain injury cases. KRS 304.39-060(2)(c) states that the tort limitations in paragraph (a) do not apply to injury to a person who is not an owner, operator, maintainer or user of a motor vehicle within the meaning of the subtitle, and also do not apply to a person injured while a passenger on a motorcycle. Because the definition of user in KRS 304.39-020(15) reaches a person residing in a household where any person owns or maintains a motor vehicle, the exception is narrower than it first appears, but where it applies the tort claim is not limited by the abolition provision at all.</p>
<h2>The reparation ceiling in a trauma admission</h2>
<p>Basic reparation benefits stop at $10,000 for all economic loss for one person in one accident and cannot be collected from more than one obligor for the same crash. A trauma activation, imaging, a neurosurgical consult and one night of intensive care exceed that figure. The medical expense definition allows a hospital room charge above a semi-private rate only where intensive care was medically required, which is one of the few places the statute accommodates a serious injury, and it excludes noneconomic detriment from the concept of loss entirely. Everything past the ceiling depends on liability coverage, underinsured coverage, health coverage or the funding programs described below.</p>
<h2>Where the treatment happens shapes the record</h2>
<p>Louisville is the region's trauma referral point, and the records reflect that. UofL Health describes its trauma program as the region's only trauma center verified as Level I for adults by the American College of Surgeons and one of only two Level I adult trauma centers in Kentucky, reporting that it treats more than 4,200 trauma and burn patients a year and that over half of its patients come from counties outside Jefferson and its bordering counties. The published capacity includes 43 patient bays, 20 trauma and surgical intensive care beds, 16 burn beds and 50 critical care beds. For a claim, that concentration means the acute record is detailed and centralized, while the rehabilitation and cognitive follow-up records are often scattered across providers closer to home.</p>
<h2>A state fund with hard caps</h2>
<p>Kentucky operates a Traumatic Brain Injury Trust Fund through the Cabinet for Health and Family Services for people with partial or total disability resulting from a brain injury who lack other viable funding, and the program applies no family income cap. Covered services include case management, community residential support, structured day programs, psychological services, prevocational and supported employment services, companion and respite services, occupational therapy, speech and language therapy, and behavioral programming. The published limits are $15,000 per person per year and $60,000 over a lifetime, with case management excluded from those caps. The program does not cover institutionalization or hospitalization, medication, attorney fees, court costs, fines or costs associated with incarceration. Those figures are worth knowing precisely, because a fund with a five-figure lifetime cap is a supplement to a brain injury care plan rather than a solution to it.</p>
<h2>Documenting a cognitive injury</h2>
<p>The evidence in these files is different from an orthopedic claim. Emergency records showing loss of consciousness, amnesia or a Glasgow Coma Scale entry anchor the acute event. Neuropsychological testing measures deficits that imaging does not show. Statements from family members, coworkers and supervisors describing changes in memory, temper, word finding and stamina supply the before-and-after comparison that a chart cannot. Employment records showing missed deadlines, reduced hours or a role change convert cognitive symptoms into economic loss. Where a life care plan is prepared, it translates the medical picture into future cost, which is the part of the claim that the reparation ceiling never reaches.</p>
<h2>Capacity, time limits and who signs</h2>
<p>Two procedural points come up repeatedly. Where an injury impairs capacity, questions about who may sign a release or authorize a settlement arise early, and Kentucky's general tolling statute for infancy and unsound mind, KRS 413.170, is written to reach the limitation periods in KRS 413.090 to 413.160; the motor vehicle reparation period appears in a different chapter and KRS 304.39-230(5) provides that a period of legal disability counts as part of the time limited there. That distinction is the kind of detail worth confirming with counsel rather than assuming. This page is general information about Kentucky law and funding programs, not legal advice about a specific brain injury, and the attorney who advertises on this site is the person to consult about an individual claim.</p>
