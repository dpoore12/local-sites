...
Supply line spraying under a Willow Glen crawlspace, sewage coming up the shower drain, or every tap gone dry? San Jose emergency plumbing troubleshooting, and a number that puts a Santa Clara County plumber on the way.

## hero_promise

A pipe that is spraying right now gets a plumber sent today, not an appointment for Thursday. The truck carries copper, PEX, shark-bite couplings, water heater fittings, a drum machine and a sectional cable, so the leak is usually stopped and the repair finished on that first visit. You hear the repair price before anything is cut.

## what_happens_when_you_call

Your address goes onto a route. Active water — a split supply line, a water heater dumping onto a garage slab, sewage rising out of a floor drain — jumps ahead of everything, because every extra hour of that is drywall, subfloor and cabinetry you will otherwise be paying to replace. A slow drain or a dripping angle stop gets a fixed arrival window instead. The trip charge is stated before a truck rolls, and the repair total is stated after the plumber has looked at it and before any pipe is cut open. If the fault turns out smaller than it sounded on the phone, the smaller number stands.

## what_they_will_ask

Four answers decide what comes off the truck. Whether water is still moving, and whether you managed to close the main. Where the wet is showing up — a ceiling, a slab, a garage wall, the meter box out by the sidewalk. Roughly when the house went up, because a 1950s Cambrian ranch and a 2015 North San Jose townhome fail in completely different places. And whether the trouble is one fixture or the whole house, which separates a local clog from a sewer lateral or a dead water service. If your meter is spinning with everything inside turned off, say that first.

## symptom_1_title

A supply line split and water is spraying
...
A drain is backing up and the water is not going down
...
Sewage is coming up out of a drain or a toilet
...
Do I need a permit for an emergency water heater replacement in San Jose?

## qa_1_answer

Yes. The city's own water heater page states plainly that installing or replacing a water heater requires a plumbing permit, and that an electrical permit may also be needed depending on the type. For a single-family house or duplex the permit is pulled online through SJPermits.org, and a permit card is issued listing the inspections. That is not optional paperwork you can skip because the tank failed on a Sunday. Venting, gas connections and seismic strapping are exactly what the inspection is checking, and this is earthquake country. A plumber can swap the tank now and carry the permit and inspection through afterward.

## qa_2_question

Why does San Jose water keep killing water heaters and fixtures?

## qa_2_answer

Because much of the city drinks very hard water. San Jose Water publishes hardness by source type: groundwater runs 11 to 26 grains per gallon, mountain surface water 5 to 12, and imported surface water 4 to 9, against its own threshold of 7 grains for water being called hard. Groundwater-served neighborhoods are getting water several times harder than that line. Dissolved calcium precipitates out as scale on the hottest surface it touches, which is the bottom of your water heater tank and the inside of every valve seat. That is why tanks rumble, why an anode rod is used up early, why angle stops seize, and why a heater that should last a decade starts leaking sooner here.

## qa_3_question

Can somebody actually come out tonight, or am I waiting until morning?

## qa_3_answer

It depends on what is happening. Water actively escaping, sewage inside the building, or a whole house with no supply are dispatched as fast as a plumber can get across Santa Clara County, because all three get worse while you wait. A single slow drain, a dripping shutoff, or a running toilet is honestly better booked for daylight, when the work is done at a normal rate and a supply house is open if a part is needed. If your situation can wait until morning without costing you anything, you will be told that instead of being sold an after-hours visit you did not need.
...
Dispatched while the water is still moving

## value_1

Active leaks, sewage indoors and a house with no supply are routed first. The plumber arrives with pipe, fittings and a drain machine already loaded, so the fix happens on that visit.

## value_2_title

The number comes before the cutting

## value_2

You are told the trip charge before a truck leaves and the repair total once the fault is found — not after a wall is open. A smaller job than expected is billed as the smaller job.

## value_3_title

Written for what is buried here

## value_3

Galvanized supply lines, cast iron drains, root-packed laterals and scale from hard groundwater. The failures in this city are specific, and so is what gets loaded to fix them.

## value_4_title

San Jose and the rest of the valley

## value_4

Coverage runs across Santa Clara County, from the older flatland tracts to the hillside subdivisions on both sides of the city.
...
Close the main valve or the one at the meter if anything is spraying. Then say what is wet, what is still running, and what you already turned off.

## step_2_title

Fixture, drain, lateral or supply

## step_2

Those four point at four different sets of tools. A couple of questions decides whether a cable machine, a repair coupling or a service line crew needs to be on the truck.

## step_3_title

A time and a price, not a maybe

## step_3

Emergencies go out now. Everything else gets a real window. You will know which of the two you have before the call ends.

## expect_intro_1

The call is short. You will be asked whether water is still moving, where it is showing up, roughly how old the house is, and whether the problem is one fixture or all of them. That is normally enough to know whether this is a burst line, a blocked lateral or a dead water service.
...
Whether the main is closed

## expect_1

Look for a valve near the front hose bib, inside the garage wall, or in a box at the front of the lot. Turn it clockwise. If it will not seal, the valve at the meter by the sidewalk is the backup, and a failed main valve is a repair worth adding to the visit.
...
A ceiling stain, a wet garage slab, water at the base of the toilet and a soggy patch in the front lawn all mean different pipes. Be specific about the room and whether it is above or below you.
...
The decade is plenty. San Jose's median home dates to 1975, but the range runs from pre-war Willow Glen bungalows through mid-century Cambrian tracts and Eichler blocks to construction finished last year. That one answer narrows the piping material faster than anything else.
...
A single slow sink is a branch line. Two or more fixtures backing up together points at the building drain or the lateral. Nothing at all anywhere points at the water service. Check a second tap before you call.

## factors_lede

San Jose houses were plumbed across seven decades with four different materials. Four things decide what gets loaded before the truck leaves.

## factor_1_title

Whether water is still escaping

## factor_1

An active leak is priced and scheduled differently from a drip, because the cost of waiting is drywall and flooring. Say whether you got the main closed.
...
Galvanized steel, cast iron, copper and PEX each fail their own way and each need their own fittings. The build era of the house is the fastest clue to which one is in the wall.

## factor_3_title

How far down the line the fault is

## factor_3

A trap, a branch, the building drain, or the lateral out under the sidewalk. Each step further out means a bigger machine, and past the property line it becomes a permit and inspection job.
...
Why San Jose homeowners call

## values_head

A plumber on the way, not a slot next week

## values_lede

Water escaping into a house is not something you schedule around. It gets shut off, priced, and repaired on the same visit.

## problem_lede

Four failures account for most of the after-hours calls out of San Jose. Each one is explained in full below, including what to shut off before anyone arrives.

## problem_nudge

Read this as background, not as a verdict on your house. The real fault gets identified by a plumber with hands on the pipe. Sorting out which of these four you are seeing simply keeps the correct machine from sitting back at the shop while you wait.
