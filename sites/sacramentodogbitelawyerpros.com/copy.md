...
### How you know this is a child's claim and not the parents'

Two claims come out of one bite, and they are owned by different people. The child owns the injury claim, which is the pain, the scarring, the future care, and any lasting limitation. A parent owns the out-of-pocket losses they paid and any independent claim recognized on the facts. The distinction is not academic in Sacramento, because a child's claim is usually the one that outlives the treatment. Civil Code section 3342 applies exactly as it does to an adult: ownership of the dog, a bite, lawful presence, and harm. What changes is the proof of harm, which is built out of pediatric records over months rather than a discharge summary from one urgent-care visit.
...
The wound description in the provider's own words, including body area, depth, repair method, and any nerve or tendon note. Referrals for scar management, plastic surgery, infection follow-up, or counseling. Dated photographs taken in the same light as swelling drops. School absence notes and the mileage and time cost of appointments. A short factual note of which adults were present and why the child was there. Ask the treating clinic which animal control agency it notified, because the reporting duty under state rabies regulation belongs to more than the family, and get the report number in writing.

### The mistake that costs a child's case

Resolving it early. A facial or hand wound on a growing child is not medically finished at discharge, and scar revision is often deferred for months or years until growth allows it, so a value discussed in week three is a value set before the injury is known. The other frequent error is a public one: posting photos and a narrative online, which becomes discovery material, and asking a child to retell the event repeatedly until the retelling is the memory.
