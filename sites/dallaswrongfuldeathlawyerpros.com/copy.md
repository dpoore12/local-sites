...
Section 74.301 limits noneconomic damages in a health-care liability action. Its stated statutory limits are $250,000 for each claimant against a physician or provider other than a health-care institution; $250,000 for each claimant against a single health-care institution; and no more than $500,000 per claimant for institutions in the aggregate. Section 74.303 is the separate provision for a health-care wrongful death or survival action, capping all damages at $500,000 per claimant subject to the consumer-price adjustment its subsection (b) describes, and excluding past and future medical, hospital and custodial care expenses from that limit.
...
### The office exists because the statute requires it

Article 49.25 of the [Code of Criminal Procedure](https://statutes.capitol.texas.gov/Docs/CR/htm/CR.49.htm) provides that the commissioners court of a county with a population of more than 2,500,000 shall establish and maintain a medical examiner's office. The Census Bureau estimates Dallas County's population at [2,661,397 as of July 1, 2025](https://www.census.gov/quickfacts/fact/table/dallascountytexas/PST045225), which places the county inside that mandate. The office operates as the Southwestern Institute of Forensic Sciences at 2355 North Stemmons Freeway.
...
### Which deaths the examiner must investigate
...
### Records, fees and what can be withheld
...
### Preserving the material the examiner does not hold
...
### The jury awards proportioned damages and divides them into shares

Section 71.010 of the [Civil Practice and Remedies Code](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.71.htm) directs that the jury may award damages in an amount proportioned to the injury resulting from the death, and shall divide the damages into shares among the persons entitled to recover who are alive at that time. Two features of that sentence matter. Losses are assessed by reference to the injury each beneficiary suffered, and the division is made inside the case rather than by agreement beforehand.

Because Section 71.004 gives the action to the surviving spouse, children and parents for their exclusive benefit, and allows one of them to sue for all, a single petition can carry several beneficiaries whose circumstances differ widely. A dependent minor child and an independent adult child are both beneficiaries, and the shares need not be equal.

### What the wrongful death side of the case is about

The wrongful death claim addresses what the named relatives lost through the death. Texas practice recognizes categories including lost earning capacity and financial contribution, lost household services, loss of companionship and society, mental anguish and loss of inheritance, and funeral and burial expenses where they were incurred. Evidence for those categories is ordinary evidence: earnings history, tax records, household arrangements, testimony about the relationship and the deceased person's age, health and work life.

Section 71.011 adds a protection that surprises families: a wrongful death recovery is not exposed to the debts the deceased person left behind. That is a meaningful difference from the estate's side of the case.

### What the survival side of the case is about

Section 71.021 continues the injured person's own personal injury action for the heirs, legal representatives and estate. The losses it covers belong to the period before death, which typically means medical expenses incurred, physical pain and mental anguish suffered before dying, and any lost earnings during that period. Because the recovery is estate property, it passes through administration and is exposed to creditors and expenses in a way a wrongful death recovery is not.

### Exemplary damages sit outside the compensatory categories

Section 71.009 allows exemplary damages where the death resulted from a willful act or omission or gross negligence. [Chapter 41](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.41.htm) then controls them: Section 41.003 requires clear and convincing evidence and a unanimous jury, Section 41.004 requires more than nominal damages to support an award, Section 41.008 supplies the cap and its exceptions, and Section 41.011 lists the factors a jury considers, including the net worth of the defendant. Section 41.008(e) provides that the cap may not be made known to the jury.

### The limits that depend on the defendant

Three statutory ceilings can reshape the analysis, and none of them comes from Chapter 71. In a health care liability claim, [Section 74.301](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.74.htm) limits noneconomic damages and Section 74.303 limits all damages in a wrongful death or survival action to $500,000 per claimant, subject to the consumer price adjustment described in its subsection (b) and excluding past and future medical, hospital and custodial care expenses. Against a governmental unit, [Section 101.023](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.101.htm) of the Tort Claims Act sets maximum liability amounts that differ by the type of entity. Against a covered employer, the Labor Code's exclusive remedy rule leaves only the statutory exemplary damages route.

Proportionate responsibility is a fourth limit. [Section 33.012](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.33.htm) reduces a recovery by the claimant's percentage of responsibility, and Section 33.001 bars it entirely above 50 percent.

### A minor's share is handled by the court

Where a beneficiary is a minor or an incapacitated person, [Chapter 142 of the Property Code](https://statutes.capitol.texas.gov/Docs/PR/htm/PR.142.htm) allows the court to decree how the recovery is invested and managed. Section 142.002 provides for a bonded manager, Section 142.004 describes permitted investments and Section 142.009 sets requirements for a structured settlement annuity, including that the issuer be licensed in Texas with at least $1 million in capital and surplus and that the arrangement be approved by the court.

### Why this page states no amounts

Every figure in a death case comes from evidence about a specific person: what they earned, who depended on them, how long they were expected to work and what the relationships actually were. A statute can supply a ceiling. It cannot supply a value, and no page written before anyone has seen a record should try to.

### Where the defendant is the employer

A claim against a covered employer is the narrowest situation of all. [Section 408.001 of the Labor Code](https://statutes.capitol.texas.gov/Docs/LA/htm/LA.408.htm) makes the recovery of workers' compensation benefits the only remedy a legal beneficiary has against that employer where a death is work-related, and subsection (b) leaves nothing behind except the statutory exemplary damages route for a surviving spouse or heirs of the body. [Section 33.002(c)(1)](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.33.htm) then takes that action outside the proportionate responsibility chapter altogether.

So the same death can produce a benefits claim with defined statutory amounts, a narrow exemplary damages claim against the employer, and an ordinary damages claim against a company that was not the employer, each measured differently.
...
### The Dallas County figures for alcohol-related crashes

TxDOT's [2025 DUI crash table by county](https://www.txdot.gov/content/dam/docs/division/trf/crash-records/2025/2025-dui-crashes-injuries-county.pdf), processed as of April 7, 2026, records 1,986 alcohol-related crashes in Dallas County, of which 71 were fatal, producing 79 deaths, along with 122 suspected serious injury crashes and 174 serious injuries. Against the [county's 258 fatal crashes and 274 total traffic deaths](https://www.txdot.gov/content/dam/docs/division/trf/crash-records/2025/2025-crashes-injuries-county.pdf) for the year, alcohol appears in a large share of the county's fatal crash record.

### The criminal case and the civil claim are separate

Section 71.006 of the [Civil Practice and Remedies Code](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.71.htm) states that an action is not precluded because the death was caused by a felonious act or because a criminal prosecution is pending. The two proceedings have different parties, different standards of proof and different timetables. A family waiting for a criminal case to conclude before asking about the civil deadline in Section 16.003(b) can lose time it cannot recover.
...
### The statutory action against a provider of alcohol

[Chapter 2 of the Alcoholic Beverage Code](https://statutes.capitol.texas.gov/Docs/AL/htm/AL.2.htm) defines a provider as a person who sells or serves an alcoholic beverage under a permit or license, or who otherwise sells an alcoholic beverage to an individual. Section 2.02(b) allows an action against a provider only on proof of two things: that at the time the beverage was provided it was apparent to the provider that the individual being sold or served was obviously intoxicated to the extent that the individual presented a clear danger to himself and others, and that the individual's intoxication was a proximate cause of the damages suffered.
...
### Employers, hosts and vehicle owners
...
### What the record will contain in a Dallas case
...
### Who brings the claim, and by when

The beneficiary structure is the same as in any Texas death case. [Section 71.004](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.71.htm) gives the wrongful death action to the surviving spouse, children and parents for their exclusive benefit, and Section 71.021 carries the deceased person's own injury claim forward for the heirs, legal representatives and estate. Section 71.010 has the jury divide any award into shares among those entitled to recover.

The filing period in [Section 16.003(b)](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.16.htm) runs two years from the death, and it does not pause while a criminal prosecution proceeds. Where a licensed establishment is a potential defendant, its own records are on commercial retention schedules that expire much sooner than that.
...
Section 71.009 of the [same code](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.71.htm) states that exemplary damages may be recovered where the death is caused by the willful act or omission or gross negligence of the defendant. That establishes availability in a death case. Everything about proof, procedure and amount then comes from Chapter 41.
...
Where the defendant is the deceased worker's covered employer, [Section 408.001(b) of the Labor Code](https://statutes.capitol.texas.gov/Docs/LA/htm/LA.408.htm) is the only route that remains: that subsection keeps an exemplary damages claim open to a surviving spouse, or to heirs of the body, where a death was produced by the employer's own intentional conduct or by its gross negligence, with subsection (c) borrowing the Chapter 41 definition. [Section 33.002(c)(1)](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.33.htm) then removes that action from the proportionate responsibility chapter entirely.

### One reporting consequence worth knowing

Where exemplary damages are awarded under Chapter 41 against a licensed long-term care institution, [Section 242.051 of the Health and Safety Code](https://statutes.capitol.texas.gov/Docs/HS/htm/HS.242.htm) requires the court to notify the licensing department. It is a small provision, and it illustrates how a finding of gross negligence can have regulatory consequences beyond the judgment itself.
...
[Section 16.003(b)](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.16.htm) requires an action for injury resulting in death to be brought within two years, and states that the action accrues on the death of the injured person. Chapter 16 also contains provisions that can affect the calculation, including Section 16.001 on legal disability, Section 16.063 on a defendant's absence from the state and Section 16.064 on refiling after a dismissal for want of jurisdiction. Those are reasons to have a date reviewed, not reasons to assume extra time.

### The examiner reaches an independent conclusion

A Dallas County traffic death normally becomes a medical examiner case as well as a police case. The [Southwestern Institute of Forensic Sciences 2025 annual report](https://www.dallascounty.org/Assets/uploads/docs/swifs/annual-reports/NAME-IA_2025-Annual-Report.pdf) records 5,865 deaths certified in the year, 647 of them certified with a motor vehicle accident manner, out of 3,129 autopsies performed.
...
### The duty owed depends on the status of the person on the land

Texas premises law scales the duty by the visitor's relationship to the property. Someone invited for the owner's benefit is owed more than someone merely tolerated, and a trespasser is owed the least. That classification is decided on the facts of the entry, not on how the parties describe it afterward, and it usually controls what has to be proved about the owner's knowledge of the condition.

### The trespasser provision, and the exception for children

[Section 75.007 of the Civil Practice and Remedies Code](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.75.htm) states that an owner, lessee or occupant of land does not owe a duty of care to a trespasser except to refrain from injuring the trespasser willfully, wantonly or through gross negligence. The section then sets out an exception for a child trespasser where an artificial condition exists that the owner knew or reasonably should have known children were likely to trespass near, where the condition posed an unreasonable risk of death or serious bodily harm that the child could not appreciate, and where the burden of eliminating it was slight compared with the risk.

Section 75.002 separately limits the liability of an owner who allows another person to use the property for recreation, which can matter where a death occurred on land opened for that purpose.

### Chapter 71 is still the vehicle for the claim

[Section 71.002](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.71.htm) creates liability where a person's wrongful act, neglect, carelessness, unskillfulness or default causes an injury resulting in death, and Section 71.003 confines the chapter to cases the injured individual could have brought had that individual lived. Section 71.004 names the beneficiaries, and Section 71.021 keeps the deceased person's own claim alive for the estate. A premises death produces the same two-claim structure as a collision.

### Fault gets divided here too

Under [Section 33.001](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.33.htm), a claimant is barred from recovery where the claimant's percentage of responsibility exceeds 50 percent, and Section 33.012 reduces the award by that percentage below the bar. In a premises case the owner will often argue that the condition was open and obvious or that the deceased person disregarded a warning, and the allocation question is where that argument lands.

### Where the immediate cause was another person's crime

A death caused by an assault or shooting on someone else's property raises the separate question of what the property owner knew about the risk and what security measures existed. On exemplary damages, [Section 41.005](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.41.htm) provides that they are generally not recoverable against a defendant for the criminal act of another, subject to exceptions the section sets out for certain conduct of employees. Ordinary negligence claims against the owner are analyzed on their own terms, which is why prior incident reports, calls for service, lighting surveys, gate and access records and security contracts are the documents that usually matter.

### The evidence is physical, and it is under the owner's control

A stairwell, a balcony rail, a pool gate, a parking structure light, a floor surface, a security door, a pump or an electrical panel can be repaired within days of a death, and there is nothing improper about an owner making a dangerous condition safe. It does mean that measurements, photographs, maintenance histories, work orders, inspection records and video have to be requested in writing early, and that video retention in particular is often measured in days or weeks.

### Who investigated, and what the file will say

For a death on private property in Dallas, the investigating agency may be the Dallas Police Department, another municipal department or a constable or sheriff's office depending on location. In a fatal case the [Southwestern Institute of Forensic Sciences](https://www.dallascounty.org/departments/swifs/faqs.php) also becomes a custodian. Its 2025 annual report describes a caseload including 374 certified homicides and 647 deaths certified with a motor vehicle accident manner, out of 5,865 deaths certified in the year, which is a useful reminder that the manner of death recorded by the examiner is an independent determination rather than a restatement of the police narrative.

### The deadlines on a premises death

The general period in [Section 16.003(b)](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.16.htm) is two years, running from the death. Where the property belongs to a city, county, school district, housing authority or other governmental unit, the Tort Claims Act's notice requirement in [Section 101.101](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.101.htm) can require written notice within six months, or sooner where a charter or ordinance says so, and Section 101.023 limits the amount recoverable according to the type of entity.

A public housing stairwell, a park structure, a school facility or a transit platform therefore raises a notice question long before it raises a filing question. Identifying the owner of the land, which is a records question rather than an impression, is usually the first thing worth confirming.
...
### How much of the Dallas County crash picture involves commercial vehicles

TxDOT's 2025 county tables, processed as of April 7, 2026, record [3,778 crashes in Dallas County involving a commercial motor vehicle](https://www.txdot.gov/content/dam/docs/division/trf/crash-records/2025/2025-cmv-involved-crashes-injuries-county.pdf), including 33 fatal crashes that produced 37 deaths, along with 101 suspected serious injury crashes. Set against [258 fatal crashes and 274 traffic deaths countywide](https://www.txdot.gov/content/dam/docs/division/trf/crash-records/2025/2025-crashes-injuries-county.pdf) for the same year, commercial vehicles appear in a minority of fatal crashes but a substantial one.
...
The Federal Motor Carrier Safety Administration's [summary of the hours of service rules](https://www.fmcsa.dot.gov/regulations/hours-service/summary-hours-service-regulations) describes an 11-hour driving limit after 10 consecutive hours off duty, a bar on driving beyond the 14th consecutive hour after coming on duty, a required 30-minute break after 8 cumulative hours of driving, weekly limits of 60 hours in 7 days or 70 hours in 8 days, a 34-hour restart, and a sleeper-berth split requiring one period of at least 2 hours and another of at least 7 consecutive hours in the berth. Adverse driving conditions can extend the driving window by up to 2 hours, and a short-haul exception applies within a 150 air-mile radius.
...
Under [49 CFR 395.8(k)(1)](https://www.govinfo.gov/content/pkg/CFR-2024-title49-vol5/pdf/CFR-2024-title49-vol5-sec395-8.pdf), a carrier is required to keep each driver's records of duty status, together with the supporting documents behind them, for a minimum of six months running from the date they were received. Under [49 CFR 390.15(b)](https://www.govinfo.gov/content/pkg/CFR-2024-title49-vol5/pdf/CFR-2024-title49-vol5-sec390-15.pdf), a carrier must maintain an accident register for three years after the date of each accident.
...
Where a tractor-trailer, one or more passenger vehicles and possibly a road authority all appear in the same crash, [Chapter 33](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.33.htm) governs how responsibility gets divided. Section 33.003 has the trier of fact determine a percentage of responsibility for each claimant, defendant, settling person and responsible third party submitted to it. Section 33.013 then makes a liable defendant severally liable for its own percentage unless the statutory threshold for joint and several liability is met.
...
### The statute names plant proprietors directly

Section 71.002(c) of the [Civil Practice and Remedies Code](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.71.htm) makes a person liable for damages arising from an injury causing death where the person is a proprietor, owner, charterer or hirer of an industrial or public utility plant, a railroad, a street railway, a steamboat, a stagecoach or another vehicle for transporting goods or passengers, and the death is caused by the negligence or carelessness of a servant or agent. Subsection (d) addresses a receiver or trustee in control of a railroad. Section 71.003 keeps the whole chapter tied to whether the injured individual could have sued had that individual lived.

Section 71.007 then removes a common defense: an agreement by an owner or operator of a plant or machinery to waive liability for injury or death is ineffective. Between them, those provisions mean an industrial death is not analyzed purely as an employment matter, and a signed waiver is not the end of the discussion.

### What kills people in Texas industrial settings, statistically

The Texas Department of Insurance [2024 fatality report](https://www.tdi.texas.gov/wc/safety/sis/documents/2024fatalrpt.pdf) counts 28 manufacturing fatalities and 62 in natural resources and mining for the year. By event type it attributes 16 percent of all Texas work fatalities to contact with objects and equipment, and notes that 56 percent of those contact deaths involved being struck by propelled, falling or suspended objects. Exposure to harmful substances or environments accounted for 11 percent of the state total, including 24 deaths involving electricity and 24 involving harmful substances. Explosions and fires accounted for 10 deaths.

Each of those categories corresponds to a document set. A struck-by death points at rigging, load plans and equipment inspection records. An electrical death points at energy isolation procedures and permits. A substance exposure points at process safety information, ventilation records and monitoring data.

### Contractor deaths inside somebody else's plant

Much of the maintenance, turnaround and specialty work in an industrial facility is performed by contractors. That produces the recurring question of who owed a duty about a condition of the premises, who directed the specific task and who controlled the energy sources or process being worked on. The answer is built from the master service agreement, the work order, the permit to work, the contractor safety manual, the site orientation records and the shift handover notes.

Where the worker's own employer subscribed to workers' compensation, [Section 408.001 of the Labor Code](https://statutes.capitol.texas.gov/Docs/LA/htm/LA.408.htm) governs what remains available against that employer, while the plant owner's position is a different question with a different answer. [Section 406.033](https://statutes.capitol.texas.gov/Docs/LA/htm/LA.406.htm) matters instead where the employer did not subscribe.

### Physical evidence in a plant changes quickly

An operating facility has strong reasons to restore production. Equipment is repaired or replaced, valves and guards are reinstalled, control system data ages out of its retention window, and the scene is cleaned before an outside expert has ever seen it. Alarm histories, distributed control system logs, maintenance work orders and calibration records exist but are typically kept on retention schedules measured in months.

A written preservation request identifying specific systems, dates and equipment numbers is more useful than a general request to keep everything, because it can be answered.

### Where a public utility or governmental operator is involved

If the operator is a public utility district, a municipal utility or another governmental unit, the Texas Tort Claims Act enters. [Section 101.021](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.101.htm) describes the limited circumstances in which liability is waived, tied to the operation of motor-driven vehicles and equipment and to a condition or use of tangible personal or real property. Section 101.101 adds the six-month notice requirement, subject to shorter charter or ordinance periods. Those are threshold questions, not damages questions.

### Exemplary damages have their own standard here

Section 71.009 permits exemplary damages where a death resulted from a willful act or omission or gross negligence. [Chapter 41](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.41.htm) then defines gross negligence as an act or omission involving an extreme degree of risk of which the actor had actual subjective awareness while proceeding with conscious indifference, and requires clear and convincing evidence with a unanimous jury finding. Industrial cases often feature repeated warnings, prior incidents or ignored recommendations, and those documents are relevant precisely because the statutory test is about awareness.

### Whether the examiner takes the case

An industrial death is likely to fall inside the medical examiner's statutory duty to investigate. Section 6(a) of Article 49.25 of the [Code of Criminal Procedure](https://statutes.capitol.texas.gov/Docs/CR/htm/CR.49.htm) covers a person killed or dying an unnatural death, a death within 24 hours of admission to a hospital or institution, and a death where the circumstances suggest unlawful means, among other categories. Section 9(a) allows the examiner to perform an autopsy where the examiner considers it necessary, or where the district or county attorney asks for one.

The examiner's file is independent of anything the plant produces internally, which is one of the reasons it matters in a case where the operator controls the scene, the data historian and most of the witnesses.
...
### Presuit notice, and the authorization that travels with it
...
Section 74.351 requires a claimant to serve one or more expert reports with the expert's curriculum vitae on each party not later than 120 days after that defendant's original answer is filed. A defendant must object to the sufficiency of a report within 21 days. If no report is served in time, the statute directs dismissal with prejudice on motion, together with reasonable attorney's fees and costs of court, and the court may grant one 30-day extension. The [Texas Supreme Court's opinion in Faber](https://www.txcourts.gov/media/1453693/200802.pdf) discusses that requirement and its consequences.
...
### The dollar limits are specific and they are layered
...
### What counts as a health care liability claim is broader than it sounds
...
### A public hospital or district adds another layer

Where the provider is a governmental unit, the Tort Claims Act's notice provision in [Section 101.101](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.101.htm) can require written notice within six months, and the liability limits in Section 101.023 apply alongside Chapter 74. [Section 281.056 of the Health and Safety Code](https://statutes.capitol.texas.gov/Docs/HS/htm/HS.281.htm) adds a venue rule of its own: a health care liability claim against a hospital district may be brought only in the county in which the district is established. For a district serving Dallas County, that points the case at the courts on Commerce Street rather than anywhere else.
...
### The licensing chapter sets a floor, and calls a violation unlawful

[Chapter 242 of the Health and Safety Code](https://statutes.capitol.texas.gov/Docs/HS/htm/HS.242.htm) opens by stating that the chapter's purpose is to provide for the development and enforcement of rules establishing minimum acceptable levels of care, and that a violation of a minimum acceptable level of care is a violation of law. That framing is useful because it identifies where the applicable standards come from. It does not by itself establish that a particular death resulted from a violation.

### Survey findings are largely kept out of a civil case

Section 242.017 provides that a statement of findings from a survey or an assessment of an administrative penalty is generally not admissible in a civil action. The section contains narrow exceptions, including where the finding concerns the same incident or the same individual whose care is at issue, or where a substantially similar finding became final and unappealable within the year before the incident.

Families often expect an inspection report to be the centerpiece of a case. The statute is the reason it usually is not, and the reason the underlying facility records matter more than the regulator's summary of them.

### Chapter 74 applies to the facility

Section 74.001(11) of the [Civil Practice and Remedies Code](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.74.htm) includes a nursing home and an assisted living facility in its definition of a health care institution. A claim against the facility therefore carries the chapter's 60-day presuit notice requirement with the statutory authorization, the 120-day expert report deadline in Section 74.351 and the limitations rule in Section 74.251. Section 74.301 applies the institutional noneconomic limits, and Section 74.303 supplies the separate per-claimant limit for a wrongful death or survival action against a provider.

The practical effect is that a nursing home death claim is a medical case procedurally, whatever the immediate cause looked like. Pressure injuries, falls, elopement, dehydration, medication administration and infection all get analyzed through expert reports on standards of care and causation.

### The records exist and they are specific

A long-term care chart is more granular than a hospital chart in some respects. Useful material includes the admission assessment, the care plan and its revisions, the minimum data set assessments, nursing notes, the medication administration record, treatment records for wounds, weight and intake records, fall and incident reports, physician orders, hospital transfer paperwork, and staffing schedules or assignment sheets for the relevant shifts.

Facility records are also where a change in condition shows up as a series of small entries rather than a single event, so the date range requested matters. Requesting a narrow window around a death can miss the weeks in which the condition developed.

### Residents have statutory rights, including monitoring

Section 242.501 sets out residents' rights, and among them is the right to place an electronic monitoring device in the resident's room. Section 242.849 then governs how recordings are used: a recording is admissible only if it is unedited, time and date stamped, and where a format transfer is needed, the transfer was performed by a qualified professional. Families who installed a camera should assume the recording's evidentiary value depends on how the original file is handled.

### A complaint to the regulator runs on its own track

Sections 242.551 through 242.554 describe the complaint process. A person may request an inspection by notifying the department of an alleged violation, the department conducts a preliminary review and, where the complaint warrants, an on-site inspection within a reasonable time. The complainant's name is confidential. A regulatory complaint is not a legal claim, does not toll any deadline in Chapter 74 and is not a substitute for the presuit notice that chapter requires.

### Where exemplary damages are awarded, the regulator is told
...
### The Dallas County examiner may or may not have a file

A death inside a facility is not automatically a medical examiner case. The [Dallas County Medical Examiner](https://www.dallascounty.org/departments/swifs/reporting-a-death.php) at the Southwestern Institute of Forensic Sciences takes jurisdiction in the categories the Code of Criminal Procedure specifies, which include a death within 24 hours of admission to an institution, an unnatural death and a death unattended by a physician. Where the office did take the case, the file and the death certificate can settle a manner-of-death question that the facility's own paperwork leaves open.
...
The estate's share needs a personal representative or a judicial determination of heirs. [Chapter 202 of the Estates Code](https://statutes.capitol.texas.gov/Docs/ES/htm/ES.202.htm) governs a proceeding to declare heirship: Section 202.002 states when heirship may be declared, Section 202.004 identifies who may commence the proceeding, Section 202.005 lists the contents of the application, Section 202.009 requires the court to appoint an attorney ad litem to represent heirs whose names or locations are unknown, and Section 202.151 requires the testimony of two disinterested and credible witnesses in open court unless the statutory exception applies. Where there is no will, [Chapter 201](https://statutes.capitol.texas.gov/Docs/ES/htm/ES.201.htm) determines who the heirs are, including the community and separate property rules in Sections 201.002 and 201.003.

### Where the Dallas County filings happen

Heirship and administration matters go to the county's [probate courts](https://www.dallascounty.org/government/courts/probate/), which sit on the seventh floor of the George L. Allen, Sr. Courts Building at 600 Commerce Street and hear will probates, heirship declarations, guardianships and suits appertaining to or incident to an estate. The [county clerk's probate division](https://www.dallascounty.org/government/county-clerk/probate-courts/faqs.php) handles those filings through electronic filing, and its published answers note that an attorney ad litem deposit is required in the form of a cash bond, along with publication where the statute calls for it.
...
### Provisions that can change the calculation
...
### The three calendar month provision is not a limitations period

Section 71.004(c) of the [Civil Practice and Remedies Code](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.71.htm) directs the executor or administrator to bring the action where none of the named relatives has done so within three calendar months after the death, unless all of those relatives request otherwise. It is read as a three-month deadline far more often than it should be. It allocates who brings the action, and it does not shorten anything.

### Health care claims have their own limitations statute

[Section 74.251](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.74.htm) requires a health care liability claim to be filed within two years of the occurrence of the breach or tort, or of the date the medical or health care treatment that is the subject of the claim is completed, and says so notwithstanding any other law. Subsection (b) is a statute of repose barring a claim more than ten years after the act or omission. The section also gives a minor under twelve until the fourteenth birthday to file.
...
### Governmental notice is measured in months, not years

[Section 101.101](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.101.htm) of the Texas Tort Claims Act requires written notice to the governmental unit within six months of the incident, reasonably describing the damage or injury, the time and place and the incident. The section ratifies charter and ordinance provisions requiring notice within a shorter period, and provides that the requirement does not apply where the unit has actual notice of a death, injury or property damage. Where a city, county, school district, transit authority or hospital district may be involved, this is usually the earliest deadline in the case, and the specific entity's own rule has to be checked.

### Evidence deadlines are shorter than any legal deadline

A family can be entirely inside the two-year period and still be too late for the documents that would have proved the case. A motor carrier's records of duty status are retained for [not less than six months](https://www.govinfo.gov/content/pkg/CFR-2024-title49-vol5/pdf/CFR-2024-title49-vol5-sec395-8.pdf) from receipt under federal rule, and private security video is frequently overwritten within weeks. Tissue samples held by the Dallas County examiner's office are generally retained for about a year according to the [office's own answers](https://www.dallascounty.org/departments/swifs/faqs.php).

### Filing in Dallas County when the date is close

Suit is filed with the district clerk or the county clerk, and Dallas County lists [thirteen civil district courts](https://www.dallascounty.org/government/courts/civil_district/) in the George L. Allen, Sr. Courts Building. Electronic filing is the norm rather than a counter visit. None of that changes a deadline, but the logistics are worth knowing before the last available week rather than during it.
...
### Exposure to the deceased person's debts is different

Under Section 71.011, what the wrongful death action recovers stays out of reach of the deceased person's creditors. A survival recovery is treated as estate property instead, which means creditors, administration expenses and the distribution rules of the Estates Code enter the picture. Where there is no will, [Chapter 201](https://statutes.capitol.texas.gov/Docs/ES/htm/ES.201.htm) sets out intestate succession, including Section 201.002 on the separate estate, under which a surviving spouse takes one-third of the personal property and a life estate in one-third of the land where the deceased left children, and Section 201.003 on the community estate.

### Somebody has to be authorized to prosecute the estate's claim

A relative can bring the wrongful death action in their own name under Section 71.004. The survival action needs someone with authority over the estate, which usually means letters issued by a probate court or a determination of heirship under [Chapter 202](https://statutes.capitol.texas.gov/Docs/ES/htm/ES.202.htm). Section 202.002 describes when heirship may be declared, and Section 202.005 lists what the application must contain. Texas case law recognizes limited circumstances in which heirs may sue without an administration, and whether those circumstances exist is a question for a lawyer reviewing the facts rather than an assumption to make from a website.

### Where the two claims are heard in Dallas County

Dallas County lists [thirteen civil district courts](https://www.dallascounty.org/government/courts/civil_district/), numbered from the 14th to the 298th, all sitting in the George L. Allen, Sr. Courts Building. The county's probate courts state that their subject matter includes suits appertaining to or incident to an estate, including medical malpractice and product liability matters. So a family may be looking at a negligence suit in a district court, an estate proceeding in a probate court, and a decision about whether the estate's claim travels with the negligence suit or stays with the estate.
...
### Both claims run against a clock

Section 16.003(b) of the Civil Practice and Remedies Code sets a general two-year period for an action for injury resulting in death, accruing on the death. A survival claim descends from the injured person's own personal injury action, so the accrual analysis for it can start from a different event. Where the defendant is a health care provider, [Section 74.251](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.74.htm) supplies its own two-year rule measured from the breach or tort or the completion of the relevant course of treatment, along with a ten-year statute of repose. Two claims from one death can therefore have two different date calculations, and neither is safe to estimate from memory.

### A representative appointed elsewhere, and a defendant who dies first
...
### The categories the statute names, and the ones it leaves out

[Section 71.004 of the Texas Civil Practice and Remedies Code](https://statutes.capitol.texas.gov/Docs/CP/htm/CP.71.htm) states that the wrongful death action is for the exclusive benefit of the surviving spouse, children and parents of the person who died. Nothing in the section ranks those categories against each other. A parent and an adult child are both inside the list; a brother, a sister, a grandparent and a grandchild are not named in it.

That is a hard line, and it produces results that feel wrong to families in Dallas who divided the practical work differently. A sibling who identified the body, arranged the funeral and closed out an apartment still has no beneficiary status of their own under this section. The [Texas Supreme Court's opinion in In re Mahindra](https://www.txcourts.gov/media/1441815/170019.pdf) gives a direct illustration, noting that a decedent's granddaughter was not a statutory wrongful death beneficiary.
...
If the estate's side of the matter has to proceed and there is no will, Chapter 202 of the Estates Code governs a proceeding to declare heirship. [Section 202.004](https://statutes.capitol.texas.gov/Docs/ES/htm/ES.202.htm) identifies who may commence it, Section 202.009 states that the court shall appoint an attorney ad litem to represent heirs whose names or locations are unknown, and Section 202.151 requires testimony from two disinterested and credible witnesses in open court unless the statutory exception applies.

In Dallas County that proceeding goes to one of the [three probate courts](https://www.dallascounty.org/government/courts/probate/), which sit on the seventh floor of the George L. Allen, Sr. Courts Building at 600 Commerce Street and hear will probates, heirship declarations, guardianships and suits appertaining to or incident to an estate. A family can be entirely certain who the heirs are and still need that court to say so on the record before the estate's claim can move.
